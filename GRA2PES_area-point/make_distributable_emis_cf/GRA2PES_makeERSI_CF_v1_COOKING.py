...
class inputs():
    ...
    gridded_files = ['/wrk/d2/charkins/CSD_Emissions/conus4k/Cooking21/Month08/Cooking_Mean/[DOW]/Cooking_Mean_[dayhalf].nc']
    
    # CANNOT HAVE MORE THAN ONE CURRENTLY 
    point_files = []
    
    out_file1 = '/wrk/users/charkins/emissions/V7_GRA2PES/GRA2PESv1.0_ESRI/GRA2PESv1.0_COOKING/[YYYY][MM]/[DOW]/GRA2PESv1.0_COOKING_[YYYY][MM]_[DOW]_00to11Z.nc'
    out_file2 = '/wrk/users/charkins/emissions/V7_GRA2PES/GRA2PESv1.0_ESRI/GRA2PESv1.0_COOKING/[YYYY][MM]/[DOW]/GRA2PESv1.0_COOKING_[YYYY][MM]_[DOW]_12to23Z.nc'
    
    wrfchemi_example = '/wrk/charkins/emissions/total_emis/4km_domain/wrfinput_d01_conus4k'
    
    skip_methane_output = True
    
    sector_title_output = 'Cooking Emissions'
