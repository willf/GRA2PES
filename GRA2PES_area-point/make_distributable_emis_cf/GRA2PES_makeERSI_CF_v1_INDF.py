...
class inputs():
    ...
    gridded_files = ['/wrk/users/charkins/emissions/V7_GRA2PES/AREA[YY]_ncf/Month[MM]/AreaINDF/[DOW]/AreaINDF_[dayhalf].nc']
    
    # CANNOT HAVE MORE THAN ONE CURRENTLY 
    point_files = ['/wrk/users/charkins/emissions/V7_GRA2PES/POINT[YY]_ncf_append_extra/Month[MM]/PtINDF/[DOW]/PtINDF_[dayhalf].nc']
    
    out_file1 = '/wrk/users/charkins/emissions/V7_GRA2PES/GRA2PESv1.0_ESRI/GRA2PESv1.0_INDF/[YYYY][MM]/[DOW]/GRA2PESv1.0_INDF_[YYYY][MM]_[DOW]_00to11Z.nc'
    out_file2 = '/wrk/users/charkins/emissions/V7_GRA2PES/GRA2PESv1.0_ESRI/GRA2PESv1.0_INDF/[YYYY][MM]/[DOW]/GRA2PESv1.0_INDF_[YYYY][MM]_[DOW]_12to23Z.nc'
    
    wrfchemi_example = '/wrk/charkins/emissions/total_emis/4km_domain/wrfinput_d01_conus4k'
    
    skip_methane_output = True
    
    sector_title_output = 'Industrial Fuel Combustion Emissions'
