...
class inputs():
    ...
    point_files = ['/wrk/users/charkins/emissions/V7_GRA2PES/POINT[YY]_ncf/Month[MM]/PtRAIL/[DOW]/PtRAIL_[dayhalf].nc']
    
    out_file1 = '/wrk/users/charkins/emissions/V7_GRA2PES/GRA2PESv1.0_ESRI/GRA2PESv1.0_RAIL/[YYYY][MM]/[DOW]/GRA2PESv1.0_RAIL_[YYYY][MM]_[DOW]_00to11Z.nc'
    out_file2 = '/wrk/users/charkins/emissions/V7_GRA2PES/GRA2PESv1.0_ESRI/GRA2PESv1.0_RAIL/[YYYY][MM]/[DOW]/GRA2PESv1.0_RAIL_[YYYY][MM]_[DOW]_12to23Z.nc'
    
    wrfchemi_example = '/wrk/charkins/emissions/total_emis/4km_domain/wrfinput_d01_conus4k'
    
    skip_methane_output = True
    
    sector_title_output = 'Railroad Emissions'
