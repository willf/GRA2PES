...
class inputs():
    ...
    gridded_files = ['/wrk/users/charkins/emissions/FIVE/onroad_dsl_ffCO2/[YYYY]/Month[MM]/[DOW]/onroad_dsl_[dayhalf].nc']
    
    # CANNOT HAVE MORE THAN ONE CURRENTLY 
    point_files = []
    
    out_file1 = '/wrk/users/charkins/emissions/V7_GRA2PES/GRA2PESv1.0_ESRI/GRA2PESv1.0_ONROAD_DSL/[YYYY][MM]/[DOW]/GRA2PESv1.0_ONROAD_DSL_[YYYY][MM]_[DOW]_00to11Z.nc'
    out_file2 = '/wrk/users/charkins/emissions/V7_GRA2PES/GRA2PESv1.0_ESRI/GRA2PESv1.0_ONROAD_DSL/[YYYY][MM]/[DOW]/GRA2PESv1.0_ONROAD_DSL_[YYYY][MM]_[DOW]_12to23Z.nc'
    
    wrfchemi_example = '/wrk/charkins/emissions/total_emis/4km_domain/wrfinput_d01_conus4k'
    
    skip_methane_output = True
    
    sector_title_output = 'Onroad Diesel Emissions'
