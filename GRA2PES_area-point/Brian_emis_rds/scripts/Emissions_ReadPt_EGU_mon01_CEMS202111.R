...
base.dir    <- "/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_GRA2PES2021/Stu_RELPT/output_RELPT_emis_CEMS202111"

#domain.file <- "/wrk/csd4/bmcdonald/NEI17/Relpointinfo_Criteria_n_VCP.csv"
domain.file <- "/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_GRA2PES2021/Stu_RELPT/output_RELPT_template_CEMS202111/Relpointinfo_Criteria_n_VCP.csv"
