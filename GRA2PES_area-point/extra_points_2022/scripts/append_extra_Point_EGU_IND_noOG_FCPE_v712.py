...
mm = '01'
mm_index = 1
#base_dir = '/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_wrfchemi2022_input/point/Month'+mm+'/TotlPoint'
#append_dir = '/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_wrfchemi2022_input/point_append_extra/Month'+mm+'/TotlPoint'

base_dir = '/wrk/users/charkins/emissions/V7_GRA2PES/POINT22_ncf/Month'+mm+'/TotlPoint_noOG'
append_dir = '/wrk/users/charkins/emissions/V7_GRA2PES/POINT22_ncf_append_extra/Month'+mm+'/TotlPoint_noOG'
...
CEMS_NEI_notmatch_Astack = pd.read_csv("/wrk/csd4/clyu/GHG_CO2/Improving_inventory/"+version+"/extra_points/input/CEMS_NEI_notmatch_Astack_2022"+mm+".csv")
...
Annual_NOx_Emis_MetricTon_2022mm = CEMS_NEI_notmatch_Astack.iloc[:,9]
Annual_SO2_Emis_MetricTon_2022mm = CEMS_NEI_notmatch_Astack.iloc[:,10]
Annual_CO2_Emis_MetricTon_2022mm = CEMS_NEI_notmatch_Astack.iloc[:,11]
...
GHGRP_refineries_all_stackinfo = pd.read_csv("/wrk/csd4/clyu/GHG_CO2/Improving_inventory/"+version+"/extra_points/input/GHGRP_refineries_2022_FCPE_all_stackinfo_emis.csv")
...
GHGRP_chemicals_all_stackinfo = pd.read_csv("/wrk/csd4/clyu/GHG_CO2/Improving_inventory/"+version+"/extra_points/input/GHGRP_chemicals_2022_FCPE_all_stackinfo_emis.csv")
...
GHGRP_minerals_metals_all_stackinfo = pd.read_csv("/wrk/csd4/clyu/GHG_CO2/Improving_inventory/"+version+"/extra_points/input/GHGRP_minerals_metals_2022_FCPE_all_stackinfo_emis.csv")
...
PtEGU_monthly = pd.read_csv("/wrk/csd4/charkins/emissions/GRA2PES/V7_NRT_scaling/POINT22_202411/input/PtEGU_monthly.csv")
...
for fuel in fuels_vector:
    ...
    for spec in species_vector:
        PtEGU_fuel_spec_weekdy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_'+fuel+'/weekdy/PtEGU_'+fuel+'_'+spec+'_weekdy.rds')
...
#Mimic Stu's RELPT program, convert 2022mm-scaled (month total emissions/day in the month*365) annual total emissions 
...
###########################################################################################################################
PtEGU_Coal_CO_weekdy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_Coal/weekdy/PtEGU_Coal_CO_weekdy.rds')
PtEGU_Coal_CO_satdy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_Coal/satdy/PtEGU_Coal_CO_satdy.rds')
PtEGU_Coal_CO_sundy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_Coal/sundy/PtEGU_Coal_CO_sundy.rds')
...
###########################################################################################################################
PtEGU_NG_CO_weekdy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_NG/weekdy/PtEGU_NG_CO_weekdy.rds')
PtEGU_NG_CO_satdy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_NG/satdy/PtEGU_NG_CO_satdy.rds')
PtEGU_NG_CO_sundy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_NG/sundy/PtEGU_NG_CO_sundy.rds')
...
###########################################################################################################################
PtEGU_Oil_CO_weekdy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_Oil/weekdy/PtEGU_Oil_CO_weekdy.rds')
PtEGU_Oil_CO_satdy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_Oil/satdy/PtEGU_Oil_CO_satdy.rds')
PtEGU_Oil_CO_sundy = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_Oil/sundy/PtEGU_Oil_CO_sundy.rds')
...
dayav_CO2_Emis_MetricTon_2022mm_weekdy = np.zeros(len(EGU_Fuel))
dayav_CO2_Emis_MetricTon_2022mm_satdy = np.zeros(len(EGU_Fuel))
dayav_CO2_Emis_MetricTon_2022mm_sundy = np.zeros(len(EGU_Fuel))
dayav_SO2_Emis_MetricTon_2022mm_weekdy = np.zeros(len(EGU_Fuel))
dayav_SO2_Emis_MetricTon_2022mm_satdy = np.zeros(len(EGU_Fuel))
dayav_SO2_Emis_MetricTon_2022mm_sundy = np.zeros(len(EGU_Fuel))
dayav_NOx_Emis_MetricTon_2022mm_weekdy = np.zeros(len(EGU_Fuel))
dayav_NOx_Emis_MetricTon_2022mm_satdy = np.zeros(len(EGU_Fuel))
dayav_NOx_Emis_MetricTon_2022mm_sundy = np.zeros(len(EGU_Fuel))

for pt in range(0,len(EGU_Fuel)):
    if EGU_Fuel[pt] == 'EGU_Coal':
        #metric tons per day
        dayav_CO2_Emis_MetricTon_2022mm_weekdy[pt] = Annual_CO2_Emis_MetricTon_2022mm[pt]*PtEGU_Coal_CO_5weekdy_fraction/num_weekdys
        dayav_CO2_Emis_MetricTon_2022mm_satdy[pt] = Annual_CO2_Emis_MetricTon_2022mm[pt]*PtEGU_Coal_CO_1satdy_fraction/num_satdys
        dayav_CO2_Emis_MetricTon_2022mm_sundy[pt] = Annual_CO2_Emis_MetricTon_2022mm[pt]*PtEGU_Coal_CO_1sundy_fraction/num_sundys
        dayav_SO2_Emis_MetricTon_2022mm_weekdy[pt] = Annual_SO2_Emis_MetricTon_2022mm[pt]*PtEGU_Coal_CO_5weekdy_fraction/num_weekdys
        dayav_SO2_Emis_MetricTon_2022mm_satdy[pt] = Annual_SO2_Emis_MetricTon_2022mm[pt]*PtEGU_Coal_CO_1satdy_fraction/num_satdys
        dayav_SO2_Emis_MetricTon_2022mm_sundy[pt] = Annual_SO2_Emis_MetricTon_2022mm[pt]*PtEGU_Coal_CO_1sundy_fraction/num_sundys
        dayav_NOx_Emis_MetricTon_2022mm_weekdy[pt] = Annual_NOx_Emis_MetricTon_2022mm[pt]*PtEGU_Coal_CO_5weekdy_fraction/num_weekdys
        dayav_NOx_Emis_MetricTon_2022mm_satdy[pt] = Annual_NOx_Emis_MetricTon_2022mm[pt]*PtEGU_Coal_CO_1satdy_fraction/num_satdys
        dayav_NOx_Emis_MetricTon_2022mm_sundy[pt] = Annual_NOx_Emis_MetricTon_2022mm[pt]*PtEGU_Coal_CO_1sundy_fraction/num_sundys
    elif EGU_Fuel[pt] == 'EGU_NG':
        dayav_CO2_Emis_MetricTon_2022mm_weekdy[pt] = Annual_CO2_Emis_MetricTon_2022mm[pt]*PtEGU_NG_CO_5weekdy_fraction/num_weekdys
        dayav_CO2_Emis_MetricTon_2022mm_satdy[pt] = Annual_CO2_Emis_MetricTon_2022mm[pt]*PtEGU_NG_CO_1satdy_fraction/num_satdys
        dayav_CO2_Emis_MetricTon_2022mm_sundy[pt] = Annual_CO2_Emis_MetricTon_2022mm[pt]*PtEGU_NG_CO_1sundy_fraction/num_sundys
        dayav_SO2_Emis_MetricTon_2022mm_weekdy[pt] = Annual_SO2_Emis_MetricTon_2022mm[pt]*PtEGU_NG_CO_5weekdy_fraction/num_weekdys
        dayav_SO2_Emis_MetricTon_2022mm_satdy[pt] = Annual_SO2_Emis_MetricTon_2022mm[pt]*PtEGU_NG_CO_1satdy_fraction/num_satdys
        dayav_SO2_Emis_MetricTon_2022mm_sundy[pt] = Annual_SO2_Emis_MetricTon_2022mm[pt]*PtEGU_NG_CO_1sundy_fraction/num_sundys
        dayav_NOx_Emis_MetricTon_2022mm_weekdy[pt] = Annual_NOx_Emis_MetricTon_2022mm[pt]*PtEGU_NG_CO_5weekdy_fraction/num_weekdys
        dayav_NOx_Emis_MetricTon_2022mm_satdy[pt] = Annual_NOx_Emis_MetricTon_2022mm[pt]*PtEGU_NG_CO_1satdy_fraction/num_satdys
        dayav_NOx_Emis_MetricTon_2022mm_sundy[pt] = Annual_NOx_Emis_MetricTon_2022mm[pt]*PtEGU_NG_CO_1sundy_fraction/num_sundys
    elif EGU_Fuel[pt] == 'EGU_Oil':
        dayav_CO2_Emis_MetricTon_2022mm_weekdy[pt] = Annual_CO2_Emis_MetricTon_2022mm[pt]*PtEGU_Oil_CO_5weekdy_fraction/num_weekdys
        dayav_CO2_Emis_MetricTon_2022mm_satdy[pt] = Annual_CO2_Emis_MetricTon_2022mm[pt]*PtEGU_Oil_CO_1satdy_fraction/num_satdys
        dayav_CO2_Emis_MetricTon_2022mm_sundy[pt] = Annual_CO2_Emis_MetricTon_2022mm[pt]*PtEGU_Oil_CO_1sundy_fraction/num_sundys
        dayav_SO2_Emis_MetricTon_2022mm_weekdy[pt] = Annual_SO2_Emis_MetricTon_2022mm[pt]*PtEGU_Oil_CO_5weekdy_fraction/num_weekdys
        dayav_SO2_Emis_MetricTon_2022mm_satdy[pt] = Annual_SO2_Emis_MetricTon_2022mm[pt]*PtEGU_Oil_CO_1satdy_fraction/num_satdys
        dayav_SO2_Emis_MetricTon_2022mm_sundy[pt] = Annual_SO2_Emis_MetricTon_2022mm[pt]*PtEGU_Oil_CO_1sundy_fraction/num_sundys
        dayav_NOx_Emis_MetricTon_2022mm_weekdy[pt] = Annual_NOx_Emis_MetricTon_2022mm[pt]*PtEGU_Oil_CO_5weekdy_fraction/num_weekdys
        dayav_NOx_Emis_MetricTon_2022mm_satdy[pt] = Annual_NOx_Emis_MetricTon_2022mm[pt]*PtEGU_Oil_CO_1satdy_fraction/num_satdys
        dayav_NOx_Emis_MetricTon_2022mm_sundy[pt] = Annual_NOx_Emis_MetricTon_2022mm[pt]*PtEGU_Oil_CO_1sundy_fraction/num_sundys
    else:
...
###################################################################################################
#FC_Coal 
dayav_CO2_FC_Coal_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CO2_FC_Coal_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CO2_FC_Coal_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CO2_FC_Coal_MetricTon_2022_refineries_weekdy[pt] = CO2_stack_FC_Coal_refineries[pt]*PtIND_Coal_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_Coal_MetricTon_2022_refineries_satdy[pt] = CO2_stack_FC_Coal_refineries[pt]*PtIND_Coal_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_Coal_MetricTon_2022_refineries_sundy[pt] = CO2_stack_FC_Coal_refineries[pt]*PtIND_Coal_CO_1sundy_fraction/num_sundys

#FC_NG
dayav_CO2_FC_NG_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CO2_FC_NG_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CO2_FC_NG_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CO2_FC_NG_MetricTon_2022_refineries_weekdy[pt] = CO2_stack_FC_NG_refineries[pt]*PtIND_NG_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_NG_MetricTon_2022_refineries_satdy[pt] = CO2_stack_FC_NG_refineries[pt]*PtIND_NG_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_NG_MetricTon_2022_refineries_sundy[pt] = CO2_stack_FC_NG_refineries[pt]*PtIND_NG_CO_1sundy_fraction/num_sundys

#FC_Petroleum
dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy[pt] = CO2_stack_FC_Petroleum_refineries[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy[pt] = CO2_stack_FC_Petroleum_refineries[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy[pt] = CO2_stack_FC_Petroleum_refineries[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys

#FC_Other
dayav_CO2_FC_Other_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CO2_FC_Other_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CO2_FC_Other_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CO2_FC_Other_MetricTon_2022_refineries_weekdy[pt] = CO2_stack_FC_Other_refineries[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_Other_MetricTon_2022_refineries_satdy[pt] = CO2_stack_FC_Other_refineries[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_Other_MetricTon_2022_refineries_sundy[pt] = CO2_stack_FC_Other_refineries[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys

###################################################################################################
#CH4
###################################################################################################
#FC_Coal 
dayav_CH4_FC_Coal_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CH4_FC_Coal_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CH4_FC_Coal_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CH4_FC_Coal_MetricTon_2022_refineries_weekdy[pt] = CH4_stack_FC_Coal_refineries[pt]*PtIND_Coal_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_Coal_MetricTon_2022_refineries_satdy[pt] = CH4_stack_FC_Coal_refineries[pt]*PtIND_Coal_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_Coal_MetricTon_2022_refineries_sundy[pt] = CH4_stack_FC_Coal_refineries[pt]*PtIND_Coal_CO_1sundy_fraction/num_sundys

#FC_NG
dayav_CH4_FC_NG_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CH4_FC_NG_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CH4_FC_NG_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CH4_FC_NG_MetricTon_2022_refineries_weekdy[pt] = CH4_stack_FC_NG_refineries[pt]*PtIND_NG_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_NG_MetricTon_2022_refineries_satdy[pt] = CH4_stack_FC_NG_refineries[pt]*PtIND_NG_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_NG_MetricTon_2022_refineries_sundy[pt] = CH4_stack_FC_NG_refineries[pt]*PtIND_NG_CO_1sundy_fraction/num_sundys

#FC_Petroleum
dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy[pt] = CH4_stack_FC_Petroleum_refineries[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy[pt] = CH4_stack_FC_Petroleum_refineries[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy[pt] = CH4_stack_FC_Petroleum_refineries[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys

#FC_Other
dayav_CH4_FC_Other_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CH4_FC_Other_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CH4_FC_Other_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CH4_FC_Other_MetricTon_2022_refineries_weekdy[pt] = CH4_stack_FC_Other_refineries[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_Other_MetricTon_2022_refineries_satdy[pt] = CH4_stack_FC_Other_refineries[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_Other_MetricTon_2022_refineries_sundy[pt] = CH4_stack_FC_Other_refineries[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys
...
###################################################################################################
#FC_Coal 
dayav_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CO2_FC_Coal_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CO2_FC_Coal_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy[pt] = CO2_stack_FC_Coal_chemicals[pt]*PtIND_Coal_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_Coal_MetricTon_2022_chemicals_satdy[pt] = CO2_stack_FC_Coal_chemicals[pt]*PtIND_Coal_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_Coal_MetricTon_2022_chemicals_sundy[pt] = CO2_stack_FC_Coal_chemicals[pt]*PtIND_Coal_CO_1sundy_fraction/num_sundys

#FC_NG
dayav_CO2_FC_NG_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CO2_FC_NG_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CO2_FC_NG_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CO2_FC_NG_MetricTon_2022_chemicals_weekdy[pt] = CO2_stack_FC_NG_chemicals[pt]*PtIND_NG_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_NG_MetricTon_2022_chemicals_satdy[pt] = CO2_stack_FC_NG_chemicals[pt]*PtIND_NG_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_NG_MetricTon_2022_chemicals_sundy[pt] = CO2_stack_FC_NG_chemicals[pt]*PtIND_NG_CO_1sundy_fraction/num_sundys

#FC_Petroleum
dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy[pt] = CO2_stack_FC_Petroleum_chemicals[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy[pt] = CO2_stack_FC_Petroleum_chemicals[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy[pt] = CO2_stack_FC_Petroleum_chemicals[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys

#FC_Other
dayav_CO2_FC_Other_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CO2_FC_Other_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CO2_FC_Other_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CO2_FC_Other_MetricTon_2022_chemicals_weekdy[pt] = CO2_stack_FC_Other_chemicals[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_Other_MetricTon_2022_chemicals_satdy[pt] = CO2_stack_FC_Other_chemicals[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_Other_MetricTon_2022_chemicals_sundy[pt] = CO2_stack_FC_Other_chemicals[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys

###################################################################################################
#CH4
###################################################################################################
#FC_Coal 
dayav_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CH4_FC_Coal_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CH4_FC_Coal_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy[pt] = CH4_stack_FC_Coal_chemicals[pt]*PtIND_Coal_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_Coal_MetricTon_2022_chemicals_satdy[pt] = CH4_stack_FC_Coal_chemicals[pt]*PtIND_Coal_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_Coal_MetricTon_2022_chemicals_sundy[pt] = CH4_stack_FC_Coal_chemicals[pt]*PtIND_Coal_CO_1sundy_fraction/num_sundys

#FC_NG
dayav_CH4_FC_NG_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CH4_FC_NG_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CH4_FC_NG_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CH4_FC_NG_MetricTon_2022_chemicals_weekdy[pt] = CH4_stack_FC_NG_chemicals[pt]*PtIND_NG_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_NG_MetricTon_2022_chemicals_satdy[pt] = CH4_stack_FC_NG_chemicals[pt]*PtIND_NG_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_NG_MetricTon_2022_chemicals_sundy[pt] = CH4_stack_FC_NG_chemicals[pt]*PtIND_NG_CO_1sundy_fraction/num_sundys

#FC_Petroleum
dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy[pt] = CH4_stack_FC_Petroleum_chemicals[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy[pt] = CH4_stack_FC_Petroleum_chemicals[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy[pt] = CH4_stack_FC_Petroleum_chemicals[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys

#FC_Other
dayav_CH4_FC_Other_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CH4_FC_Other_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CH4_FC_Other_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CH4_FC_Other_MetricTon_2022_chemicals_weekdy[pt] = CH4_stack_FC_Other_chemicals[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_Other_MetricTon_2022_chemicals_satdy[pt] = CH4_stack_FC_Other_chemicals[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_Other_MetricTon_2022_chemicals_sundy[pt] = CH4_stack_FC_Other_chemicals[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys
...
###################################################################################################
#FC_Coal 
dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy[pt] = CO2_stack_FC_Coal_minerals_metals[pt]*PtIND_Coal_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy[pt] = CO2_stack_FC_Coal_minerals_metals[pt]*PtIND_Coal_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy[pt] = CO2_stack_FC_Coal_minerals_metals[pt]*PtIND_Coal_CO_1sundy_fraction/num_sundys

#FC_NG
dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy[pt] = CO2_stack_FC_NG_minerals_metals[pt]*PtIND_NG_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy[pt] = CO2_stack_FC_NG_minerals_metals[pt]*PtIND_NG_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy[pt] = CO2_stack_FC_NG_minerals_metals[pt]*PtIND_NG_CO_1sundy_fraction/num_sundys

#FC_Petroleum
dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy[pt] = CO2_stack_FC_Petroleum_minerals_metals[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy[pt] = CO2_stack_FC_Petroleum_minerals_metals[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy[pt] = CO2_stack_FC_Petroleum_minerals_metals[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys

#FC_Other
dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy[pt] = CO2_stack_FC_Other_minerals_metals[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy[pt] = CO2_stack_FC_Other_minerals_metals[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy[pt] = CO2_stack_FC_Other_minerals_metals[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys

###################################################################################################
#CH4
###################################################################################################
#FC_Coal 
dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy[pt] = CH4_stack_FC_Coal_minerals_metals[pt]*PtIND_Coal_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy[pt] = CH4_stack_FC_Coal_minerals_metals[pt]*PtIND_Coal_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy[pt] = CH4_stack_FC_Coal_minerals_metals[pt]*PtIND_Coal_CO_1sundy_fraction/num_sundys

#FC_NG
dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy[pt] = CH4_stack_FC_NG_minerals_metals[pt]*PtIND_NG_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy[pt] = CH4_stack_FC_NG_minerals_metals[pt]*PtIND_NG_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy[pt] = CH4_stack_FC_NG_minerals_metals[pt]*PtIND_NG_CO_1sundy_fraction/num_sundys

#FC_Petroleum
dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy[pt] = CH4_stack_FC_Petroleum_minerals_metals[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy[pt] = CH4_stack_FC_Petroleum_minerals_metals[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy[pt] = CH4_stack_FC_Petroleum_minerals_metals[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys

#FC_Other
dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy[pt] = CH4_stack_FC_Other_minerals_metals[pt]*PtIND_Oil_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy[pt] = CH4_stack_FC_Other_minerals_metals[pt]*PtIND_Oil_CO_1satdy_fraction/num_satdys
    dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy[pt] = CH4_stack_FC_Other_minerals_metals[pt]*PtIND_Oil_CO_1sundy_fraction/num_sundys
...
#PE
dayav_CO2_PE_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CO2_PE_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CO2_PE_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CO2_PE_MetricTon_2022_refineries_weekdy[pt] = CO2_stack_PE_refineries[pt]*PtREFINE_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_PE_MetricTon_2022_refineries_satdy[pt] = CO2_stack_PE_refineries[pt]*PtREFINE_CO_1satdy_fraction/num_satdys
    dayav_CO2_PE_MetricTon_2022_refineries_sundy[pt] = CO2_stack_PE_refineries[pt]*PtREFINE_CO_1sundy_fraction/num_sundys
...
#PE
dayav_CH4_PE_MetricTon_2022_refineries_weekdy = np.zeros(len(LON_refineries))
dayav_CH4_PE_MetricTon_2022_refineries_satdy = np.zeros(len(LON_refineries))
dayav_CH4_PE_MetricTon_2022_refineries_sundy = np.zeros(len(LON_refineries))

for pt in range(0,len(LON_refineries)):
    dayav_CH4_PE_MetricTon_2022_refineries_weekdy[pt] = CH4_stack_PE_refineries[pt]*PtREFINE_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_PE_MetricTon_2022_refineries_satdy[pt] = CH4_stack_PE_refineries[pt]*PtREFINE_CO_1satdy_fraction/num_satdys
    dayav_CH4_PE_MetricTon_2022_refineries_sundy[pt] = CH4_stack_PE_refineries[pt]*PtREFINE_CO_1sundy_fraction/num_sundys
...
#PE
dayav_CO2_PE_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CO2_PE_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CO2_PE_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CO2_PE_MetricTon_2022_chemicals_weekdy[pt] = CO2_stack_PE_chemicals[pt]*PtCHEM_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_PE_MetricTon_2022_chemicals_satdy[pt] = CO2_stack_PE_chemicals[pt]*PtCHEM_CO_1satdy_fraction/num_satdys
    dayav_CO2_PE_MetricTon_2022_chemicals_sundy[pt] = CO2_stack_PE_chemicals[pt]*PtCHEM_CO_1sundy_fraction/num_sundys
...
#PE
dayav_CH4_PE_MetricTon_2022_chemicals_weekdy = np.zeros(len(LON_chemicals))
dayav_CH4_PE_MetricTon_2022_chemicals_satdy = np.zeros(len(LON_chemicals))
dayav_CH4_PE_MetricTon_2022_chemicals_sundy = np.zeros(len(LON_chemicals))

for pt in range(0,len(LON_chemicals)):
    dayav_CH4_PE_MetricTon_2022_chemicals_weekdy[pt] = CH4_stack_PE_chemicals[pt]*PtCHEM_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_PE_MetricTon_2022_chemicals_satdy[pt] = CH4_stack_PE_chemicals[pt]*PtCHEM_CO_1satdy_fraction/num_satdys
    dayav_CH4_PE_MetricTon_2022_chemicals_sundy[pt] = CH4_stack_PE_chemicals[pt]*PtCHEM_CO_1sundy_fraction/num_sundys
...
#PE
dayav_CO2_PE_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_PE_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CO2_PE_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CO2_PE_MetricTon_2022_minerals_metals_weekdy[pt] = CO2_stack_PE_minerals_metals[pt]*PtMETAL_CO_5weekdy_fraction/num_weekdys
    dayav_CO2_PE_MetricTon_2022_minerals_metals_satdy[pt] = CO2_stack_PE_minerals_metals[pt]*PtMETAL_CO_1satdy_fraction/num_satdys
    dayav_CO2_PE_MetricTon_2022_minerals_metals_sundy[pt] = CO2_stack_PE_minerals_metals[pt]*PtMETAL_CO_1sundy_fraction/num_sundys
...
#PE
dayav_CH4_PE_MetricTon_2022_minerals_metals_weekdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_PE_MetricTon_2022_minerals_metals_satdy = np.zeros(len(LON_minerals_metals))
dayav_CH4_PE_MetricTon_2022_minerals_metals_sundy = np.zeros(len(LON_minerals_metals))

for pt in range(0,len(LON_minerals_metals)):
    dayav_CH4_PE_MetricTon_2022_minerals_metals_weekdy[pt] = CH4_stack_PE_minerals_metals[pt]*PtMETAL_CO_5weekdy_fraction/num_weekdys
    dayav_CH4_PE_MetricTon_2022_minerals_metals_satdy[pt] = CH4_stack_PE_minerals_metals[pt]*PtMETAL_CO_1satdy_fraction/num_satdys
    dayav_CH4_PE_MetricTon_2022_minerals_metals_sundy[pt] = CH4_stack_PE_minerals_metals[pt]*PtMETAL_CO_1sundy_fraction/num_sundys
...
for fuel in fuels_vector:
    for dow in dow_vector:
        print("fuel",fuel)
        print("dow",dow)
        PtEGU_fuel_dow = pyreadr.read_r('/wrk/csd4/clyu/GHG_CO2/Improving_inventory/'+version+'/scal_sum_ncf/base2022mm_EGUonly_rds/point/Month'+mm+'/PtEGU_'+fuel+'/'+dow+'/PtEGU_'+fuel+'_CO_'+dow+'.rds')
...
HRall_CO2_Emis_MetricTon_2022mm_weekdy = np.zeros([24,nROW_extra_EGU])
HRall_SO2_Emis_MetricTon_2022mm_weekdy = np.zeros([24,nROW_extra_EGU])
HRall_NOx_Emis_MetricTon_2022mm_weekdy = np.zeros([24,nROW_extra_EGU])
HRall_CO2_Emis_MetricTon_2022mm_satdy = np.zeros([24,nROW_extra_EGU])
HRall_SO2_Emis_MetricTon_2022mm_satdy = np.zeros([24,nROW_extra_EGU])
HRall_NOx_Emis_MetricTon_2022mm_satdy = np.zeros([24,nROW_extra_EGU])
HRall_CO2_Emis_MetricTon_2022mm_sundy = np.zeros([24,nROW_extra_EGU])
HRall_SO2_Emis_MetricTon_2022mm_sundy = np.zeros([24,nROW_extra_EGU])
HRall_NOx_Emis_MetricTon_2022mm_sundy = np.zeros([24,nROW_extra_EGU])
...
for pt in range(0,nROW_extra_EGU):
    ...
    if state_cur in states_vector:
    ...
    elif state_cur == 'Ontario':
        state_index = states_vector.index('Michigan')
        warning_message = 'Reassigning hourly profile for Pt ' + str(pt)+  ' from Ontario to Michigan'
        print(warning_message)
        if warning:
            warning = {'Message': warning['Message']+ ' \n' + warning_message}
        else:
            warning = {'Message':  warning_message}
    elif state_cur == 'Baja California':
        state_index = states_vector.index('California')
        warning_message = 'Reassigning hourly profile for Pt ' + str(pt)+  ' from Baja California to California'
        print(warning_message)
        if warning:
            warning = {'Message': warning['Message']+ ' \n' + warning_message}
        else:
            warning = {'Message':  warning_message}
    elif state_cur == 'Washington, D.C.':
        state_index = states_vector.index('District of Columbia')
        warning_message = 'Reassigning hourly profile for Pt ' + str(pt)+  ' from Washington, D.C. to District of Columbia'
        print(warning_message)
        if warning:
            warning = {'Message': warning['Message']+ ' \n' + warning_message}
        else:
        ...
        state_index = states_vector.index('Colorado')
        warning_message = 'Reassigning hourly profile for Pt ' + str(pt)+  ' from '+ state_cur+' to Colorado (middle of country hourly profile)'
        print(warning_message)
        if warning:
            warning = {'Message': warning['Message']+ ' \n' + warning_message}
        else:
    ...
    if fuel_cur == 'EGU_Coal':
        HRall_CO2_Emis_MetricTon_2022mm_weekdy[:,pt]= dayav_CO2_Emis_MetricTon_2022mm_weekdy[pt]*PtEGU_Coal_weekdy_states_HRall_frac[state_index,:]
        HRall_SO2_Emis_MetricTon_2022mm_weekdy[:,pt]= dayav_SO2_Emis_MetricTon_2022mm_weekdy[pt]*PtEGU_Coal_weekdy_states_HRall_frac[state_index,:]
        HRall_NOx_Emis_MetricTon_2022mm_weekdy[:,pt]= dayav_NOx_Emis_MetricTon_2022mm_weekdy[pt]*PtEGU_Coal_weekdy_states_HRall_frac[state_index,:]
        HRall_CO2_Emis_MetricTon_2022mm_satdy[:,pt]= dayav_CO2_Emis_MetricTon_2022mm_satdy[pt]*PtEGU_Coal_satdy_states_HRall_frac[state_index,:]
        HRall_SO2_Emis_MetricTon_2022mm_satdy[:,pt]= dayav_SO2_Emis_MetricTon_2022mm_satdy[pt]*PtEGU_Coal_satdy_states_HRall_frac[state_index,:]
        HRall_NOx_Emis_MetricTon_2022mm_satdy[:,pt]= dayav_NOx_Emis_MetricTon_2022mm_satdy[pt]*PtEGU_Coal_satdy_states_HRall_frac[state_index,:]
        HRall_CO2_Emis_MetricTon_2022mm_sundy[:,pt]= dayav_CO2_Emis_MetricTon_2022mm_sundy[pt]*PtEGU_Coal_sundy_states_HRall_frac[state_index,:]
        HRall_SO2_Emis_MetricTon_2022mm_sundy[:,pt]= dayav_SO2_Emis_MetricTon_2022mm_sundy[pt]*PtEGU_Coal_sundy_states_HRall_frac[state_index,:]
        HRall_NOx_Emis_MetricTon_2022mm_sundy[:,pt]= dayav_NOx_Emis_MetricTon_2022mm_sundy[pt]*PtEGU_Coal_sundy_states_HRall_frac[state_index,:]
    elif fuel_cur == 'EGU_NG':
        HRall_CO2_Emis_MetricTon_2022mm_weekdy[:,pt]= dayav_CO2_Emis_MetricTon_2022mm_weekdy[pt]*PtEGU_NG_weekdy_states_HRall_frac[state_index,:]
        HRall_SO2_Emis_MetricTon_2022mm_weekdy[:,pt]= dayav_SO2_Emis_MetricTon_2022mm_weekdy[pt]*PtEGU_NG_weekdy_states_HRall_frac[state_index,:]
        HRall_NOx_Emis_MetricTon_2022mm_weekdy[:,pt]= dayav_NOx_Emis_MetricTon_2022mm_weekdy[pt]*PtEGU_NG_weekdy_states_HRall_frac[state_index,:]
        HRall_CO2_Emis_MetricTon_2022mm_satdy[:,pt]= dayav_CO2_Emis_MetricTon_2022mm_satdy[pt]*PtEGU_NG_satdy_states_HRall_frac[state_index,:]
        HRall_SO2_Emis_MetricTon_2022mm_satdy[:,pt]= dayav_SO2_Emis_MetricTon_2022mm_satdy[pt]*PtEGU_NG_satdy_states_HRall_frac[state_index,:]
        HRall_NOx_Emis_MetricTon_2022mm_satdy[:,pt]= dayav_NOx_Emis_MetricTon_2022mm_satdy[pt]*PtEGU_NG_satdy_states_HRall_frac[state_index,:]
        HRall_CO2_Emis_MetricTon_2022mm_sundy[:,pt]= dayav_CO2_Emis_MetricTon_2022mm_sundy[pt]*PtEGU_NG_sundy_states_HRall_frac[state_index,:]
        HRall_SO2_Emis_MetricTon_2022mm_sundy[:,pt]= dayav_SO2_Emis_MetricTon_2022mm_sundy[pt]*PtEGU_NG_sundy_states_HRall_frac[state_index,:]
        HRall_NOx_Emis_MetricTon_2022mm_sundy[:,pt]= dayav_NOx_Emis_MetricTon_2022mm_sundy[pt]*PtEGU_NG_sundy_states_HRall_frac[state_index,:]
    elif fuel_cur == 'EGU_Oil':
        HRall_CO2_Emis_MetricTon_2022mm_weekdy[:,pt]= dayav_CO2_Emis_MetricTon_2022mm_weekdy[pt]*PtEGU_Oil_weekdy_states_HRall_frac[state_index,:]
        HRall_SO2_Emis_MetricTon_2022mm_weekdy[:,pt]= dayav_SO2_Emis_MetricTon_2022mm_weekdy[pt]*PtEGU_Oil_weekdy_states_HRall_frac[state_index,:]
        HRall_NOx_Emis_MetricTon_2022mm_weekdy[:,pt]= dayav_NOx_Emis_MetricTon_2022mm_weekdy[pt]*PtEGU_Oil_weekdy_states_HRall_frac[state_index,:]
        HRall_CO2_Emis_MetricTon_2022mm_satdy[:,pt]= dayav_CO2_Emis_MetricTon_2022mm_satdy[pt]*PtEGU_Oil_satdy_states_HRall_frac[state_index,:]
        HRall_SO2_Emis_MetricTon_2022mm_satdy[:,pt]= dayav_SO2_Emis_MetricTon_2022mm_satdy[pt]*PtEGU_Oil_satdy_states_HRall_frac[state_index,:]
        HRall_NOx_Emis_MetricTon_2022mm_satdy[:,pt]= dayav_NOx_Emis_MetricTon_2022mm_satdy[pt]*PtEGU_Oil_satdy_states_HRall_frac[state_index,:]
        HRall_CO2_Emis_MetricTon_2022mm_sundy[:,pt]= dayav_CO2_Emis_MetricTon_2022mm_sundy[pt]*PtEGU_Oil_sundy_states_HRall_frac[state_index,:]
        HRall_SO2_Emis_MetricTon_2022mm_sundy[:,pt]= dayav_SO2_Emis_MetricTon_2022mm_sundy[pt]*PtEGU_Oil_sundy_states_HRall_frac[state_index,:]
        HRall_NOx_Emis_MetricTon_2022mm_sundy[:,pt]= dayav_NOx_Emis_MetricTon_2022mm_sundy[pt]*PtEGU_Oil_sundy_states_HRall_frac[state_index,:]
    
print("dayav_CO2_Emis_MetricTon_2022mm_weekdy",np.nansum(dayav_CO2_Emis_MetricTon_2022mm_weekdy))
print("HRall_CO2_Emis_MetricTon_2022mm_weekdy",np.nansum(HRall_CO2_Emis_MetricTon_2022mm_weekdy))
print("dayav_SO2_Emis_MetricTon_2022mm_weekdy",np.nansum(dayav_SO2_Emis_MetricTon_2022mm_weekdy))
print("HRall_SO2_Emis_MetricTon_2022mm_weekdy",np.nansum(HRall_SO2_Emis_MetricTon_2022mm_weekdy))
print("dayav_NOx_Emis_MetricTon_2022mm_weekdy",np.nansum(dayav_NOx_Emis_MetricTon_2022mm_weekdy))
print("HRall_NOx_Emis_MetricTon_2022mm_weekdy",np.nansum(HRall_NOx_Emis_MetricTon_2022mm_weekdy))
print("dayav_CO2_Emis_MetricTon_2022mm_satdy",np.nansum(dayav_CO2_Emis_MetricTon_2022mm_satdy))
print("HRall_CO2_Emis_MetricTon_2022mm_satdy",np.nansum(HRall_CO2_Emis_MetricTon_2022mm_satdy))
print("dayav_SO2_Emis_MetricTon_2022mm_satdy",np.nansum(dayav_SO2_Emis_MetricTon_2022mm_satdy))
print("HRall_SO2_Emis_MetricTon_2022mm_satdy",np.nansum(HRall_SO2_Emis_MetricTon_2022mm_satdy))
print("dayav_NOx_Emis_MetricTon_2022mm_satdy",np.nansum(dayav_NOx_Emis_MetricTon_2022mm_satdy))
print("HRall_NOx_Emis_MetricTon_2022mm_satdy",np.nansum(HRall_NOx_Emis_MetricTon_2022mm_satdy))
print("dayav_CO2_Emis_MetricTon_2022mm_sundy",np.nansum(dayav_CO2_Emis_MetricTon_2022mm_sundy))
print("HRall_CO2_Emis_MetricTon_2022mm_sundy",np.nansum(HRall_CO2_Emis_MetricTon_2022mm_sundy))
print("dayav_SO2_Emis_MetricTon_2022mm_sundy",np.nansum(dayav_SO2_Emis_MetricTon_2022mm_sundy))
print("HRall_SO2_Emis_MetricTon_2022mm_sundy",np.nansum(HRall_SO2_Emis_MetricTon_2022mm_sundy))
print("dayav_NOx_Emis_MetricTon_2022mm_sundy",np.nansum(dayav_NOx_Emis_MetricTon_2022mm_sundy))
print("HRall_NOx_Emis_MetricTon_2022mm_sundy",np.nansum(HRall_NOx_Emis_MetricTon_2022mm_sundy))
...
#CO2
###################################################################################################
HRall_CO2_FC_Coal_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_Coal_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_Coal_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_NG_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_NG_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_NG_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_Other_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_Other_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_FC_Other_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
...
for pt in range(0,len(LON_refineries)):
    ...
    HRall_CO2_FC_Coal_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CO2_FC_Coal_MetricTon_2022_refineries_weekdy[pt]*PtIND_Coal_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Coal_MetricTon_2022_refineries_satdy[:,pt]= dayav_CO2_FC_Coal_MetricTon_2022_refineries_satdy[pt]*PtIND_Coal_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Coal_MetricTon_2022_refineries_sundy[:,pt]= dayav_CO2_FC_Coal_MetricTon_2022_refineries_sundy[pt]*PtIND_Coal_sundy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_NG_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CO2_FC_NG_MetricTon_2022_refineries_weekdy[pt]*PtIND_NG_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_NG_MetricTon_2022_refineries_satdy[:,pt]= dayav_CO2_FC_NG_MetricTon_2022_refineries_satdy[pt]*PtIND_NG_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_NG_MetricTon_2022_refineries_sundy[:,pt]= dayav_CO2_FC_NG_MetricTon_2022_refineries_sundy[pt]*PtIND_NG_sundy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy[:,pt]= dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy[:,pt]= dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Other_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CO2_FC_Other_MetricTon_2022_refineries_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Other_MetricTon_2022_refineries_satdy[:,pt]= dayav_CO2_FC_Other_MetricTon_2022_refineries_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Other_MetricTon_2022_refineries_sundy[:,pt]= dayav_CO2_FC_Other_MetricTon_2022_refineries_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]

print("dayav_CO2_FC_Coal_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CO2_FC_Coal_MetricTon_2022_refineries_weekdy))
print("HRall_CO2_FC_Coal_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CO2_FC_Coal_MetricTon_2022_refineries_weekdy))
print("dayav_CO2_FC_Coal_MetricTon_2022_refineries_satdy",np.nansum(dayav_CO2_FC_Coal_MetricTon_2022_refineries_satdy))
print("HRall_CO2_FC_Coal_MetricTon_2022_refineries_satdy",np.nansum(HRall_CO2_FC_Coal_MetricTon_2022_refineries_satdy))
print("dayav_CO2_FC_Coal_MetricTon_2022_refineries_sundy",np.nansum(dayav_CO2_FC_Coal_MetricTon_2022_refineries_sundy))
print("HRall_CO2_FC_Coal_MetricTon_2022_refineries_sundy",np.nansum(HRall_CO2_FC_Coal_MetricTon_2022_refineries_sundy))
print("dayav_CO2_FC_NG_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CO2_FC_NG_MetricTon_2022_refineries_weekdy))
print("HRall_CO2_FC_NG_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CO2_FC_NG_MetricTon_2022_refineries_weekdy))
print("dayav_CO2_FC_NG_MetricTon_2022_refineries_satdy",np.nansum(dayav_CO2_FC_NG_MetricTon_2022_refineries_satdy))
print("HRall_CO2_FC_NG_MetricTon_2022_refineries_satdy",np.nansum(HRall_CO2_FC_NG_MetricTon_2022_refineries_satdy))
print("dayav_CO2_FC_NG_MetricTon_2022_refineries_sundy",np.nansum(dayav_CO2_FC_NG_MetricTon_2022_refineries_sundy))
print("HRall_CO2_FC_NG_MetricTon_2022_refineries_sundy",np.nansum(HRall_CO2_FC_NG_MetricTon_2022_refineries_sundy))
print("dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy))
print("HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy))
print("dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy",np.nansum(dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy))
print("HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy",np.nansum(HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy))
print("dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy",np.nansum(dayav_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy))
print("HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy",np.nansum(HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy))
print("dayav_CO2_FC_Other_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CO2_FC_Other_MetricTon_2022_refineries_weekdy))
print("HRall_CO2_FC_Other_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CO2_FC_Other_MetricTon_2022_refineries_weekdy))
print("dayav_CO2_FC_Other_MetricTon_2022_refineries_satdy",np.nansum(dayav_CO2_FC_Other_MetricTon_2022_refineries_satdy))
print("HRall_CO2_FC_Other_MetricTon_2022_refineries_satdy",np.nansum(HRall_CO2_FC_Other_MetricTon_2022_refineries_satdy))
print("dayav_CO2_FC_Other_MetricTon_2022_refineries_sundy",np.nansum(dayav_CO2_FC_Other_MetricTon_2022_refineries_sundy))
print("HRall_CO2_FC_Other_MetricTon_2022_refineries_sundy",np.nansum(HRall_CO2_FC_Other_MetricTon_2022_refineries_sundy))

###################################################################################################
#CH4
###################################################################################################
HRall_CH4_FC_Coal_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_Coal_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_Coal_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_NG_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_NG_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_NG_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_Other_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_Other_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_FC_Other_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
...
for pt in range(0,len(LON_refineries)):
    ...
    HRall_CH4_FC_Coal_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CH4_FC_Coal_MetricTon_2022_refineries_weekdy[pt]*PtIND_Coal_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Coal_MetricTon_2022_refineries_satdy[:,pt]= dayav_CH4_FC_Coal_MetricTon_2022_refineries_satdy[pt]*PtIND_Coal_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Coal_MetricTon_2022_refineries_sundy[:,pt]= dayav_CH4_FC_Coal_MetricTon_2022_refineries_sundy[pt]*PtIND_Coal_sundy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_NG_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CH4_FC_NG_MetricTon_2022_refineries_weekdy[pt]*PtIND_NG_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_NG_MetricTon_2022_refineries_satdy[:,pt]= dayav_CH4_FC_NG_MetricTon_2022_refineries_satdy[pt]*PtIND_NG_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_NG_MetricTon_2022_refineries_sundy[:,pt]= dayav_CH4_FC_NG_MetricTon_2022_refineries_sundy[pt]*PtIND_NG_sundy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy[:,pt]= dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy[:,pt]= dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Other_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CH4_FC_Other_MetricTon_2022_refineries_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Other_MetricTon_2022_refineries_satdy[:,pt]= dayav_CH4_FC_Other_MetricTon_2022_refineries_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Other_MetricTon_2022_refineries_sundy[:,pt]= dayav_CH4_FC_Other_MetricTon_2022_refineries_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]

print("dayav_CH4_FC_Coal_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CH4_FC_Coal_MetricTon_2022_refineries_weekdy))
print("HRall_CH4_FC_Coal_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CH4_FC_Coal_MetricTon_2022_refineries_weekdy))
print("dayav_CH4_FC_Coal_MetricTon_2022_refineries_satdy",np.nansum(dayav_CH4_FC_Coal_MetricTon_2022_refineries_satdy))
print("HRall_CH4_FC_Coal_MetricTon_2022_refineries_satdy",np.nansum(HRall_CH4_FC_Coal_MetricTon_2022_refineries_satdy))
print("dayav_CH4_FC_Coal_MetricTon_2022_refineries_sundy",np.nansum(dayav_CH4_FC_Coal_MetricTon_2022_refineries_sundy))
print("HRall_CH4_FC_Coal_MetricTon_2022_refineries_sundy",np.nansum(HRall_CH4_FC_Coal_MetricTon_2022_refineries_sundy))
print("dayav_CH4_FC_NG_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CH4_FC_NG_MetricTon_2022_refineries_weekdy))
print("HRall_CH4_FC_NG_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CH4_FC_NG_MetricTon_2022_refineries_weekdy))
print("dayav_CH4_FC_NG_MetricTon_2022_refineries_satdy",np.nansum(dayav_CH4_FC_NG_MetricTon_2022_refineries_satdy))
print("HRall_CH4_FC_NG_MetricTon_2022_refineries_satdy",np.nansum(HRall_CH4_FC_NG_MetricTon_2022_refineries_satdy))
print("dayav_CH4_FC_NG_MetricTon_2022_refineries_sundy",np.nansum(dayav_CH4_FC_NG_MetricTon_2022_refineries_sundy))
print("HRall_CH4_FC_NG_MetricTon_2022_refineries_sundy",np.nansum(HRall_CH4_FC_NG_MetricTon_2022_refineries_sundy))
print("dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy))
print("HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy))
print("dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy",np.nansum(dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy))
print("HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy",np.nansum(HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy))
print("dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy",np.nansum(dayav_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy))
print("HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy",np.nansum(HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy))
print("dayav_CH4_FC_Other_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CH4_FC_Other_MetricTon_2022_refineries_weekdy))
print("HRall_CH4_FC_Other_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CH4_FC_Other_MetricTon_2022_refineries_weekdy))
print("dayav_CH4_FC_Other_MetricTon_2022_refineries_satdy",np.nansum(dayav_CH4_FC_Other_MetricTon_2022_refineries_satdy))
print("HRall_CH4_FC_Other_MetricTon_2022_refineries_satdy",np.nansum(HRall_CH4_FC_Other_MetricTon_2022_refineries_satdy))
print("dayav_CH4_FC_Other_MetricTon_2022_refineries_sundy",np.nansum(dayav_CH4_FC_Other_MetricTon_2022_refineries_sundy))
print("HRall_CH4_FC_Other_MetricTon_2022_refineries_sundy",np.nansum(HRall_CH4_FC_Other_MetricTon_2022_refineries_sundy))
...
#CO2
###################################################################################################
HRall_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_Coal_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_Coal_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_NG_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_NG_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_NG_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_Other_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_Other_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_FC_Other_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
...
for pt in range(0,len(LON_chemicals)):
    ...
    HRall_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy[pt]*PtIND_Coal_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Coal_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CO2_FC_Coal_MetricTon_2022_chemicals_satdy[pt]*PtIND_Coal_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Coal_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CO2_FC_Coal_MetricTon_2022_chemicals_sundy[pt]*PtIND_Coal_sundy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_NG_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CO2_FC_NG_MetricTon_2022_chemicals_weekdy[pt]*PtIND_NG_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_NG_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CO2_FC_NG_MetricTon_2022_chemicals_satdy[pt]*PtIND_NG_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_NG_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CO2_FC_NG_MetricTon_2022_chemicals_sundy[pt]*PtIND_NG_sundy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Other_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CO2_FC_Other_MetricTon_2022_chemicals_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Other_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CO2_FC_Other_MetricTon_2022_chemicals_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Other_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CO2_FC_Other_MetricTon_2022_chemicals_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]

print("dayav_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy))
print("HRall_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy))
print("dayav_CO2_FC_Coal_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CO2_FC_Coal_MetricTon_2022_chemicals_satdy))
print("HRall_CO2_FC_Coal_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CO2_FC_Coal_MetricTon_2022_chemicals_satdy))
print("dayav_CO2_FC_Coal_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CO2_FC_Coal_MetricTon_2022_chemicals_sundy))
print("HRall_CO2_FC_Coal_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CO2_FC_Coal_MetricTon_2022_chemicals_sundy))
print("dayav_CO2_FC_NG_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CO2_FC_NG_MetricTon_2022_chemicals_weekdy))
print("HRall_CO2_FC_NG_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CO2_FC_NG_MetricTon_2022_chemicals_weekdy))
print("dayav_CO2_FC_NG_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CO2_FC_NG_MetricTon_2022_chemicals_satdy))
print("HRall_CO2_FC_NG_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CO2_FC_NG_MetricTon_2022_chemicals_satdy))
print("dayav_CO2_FC_NG_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CO2_FC_NG_MetricTon_2022_chemicals_sundy))
print("HRall_CO2_FC_NG_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CO2_FC_NG_MetricTon_2022_chemicals_sundy))
print("dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy))
print("HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy))
print("dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy))
print("HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy))
print("dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy))
print("HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy))
print("dayav_CO2_FC_Other_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CO2_FC_Other_MetricTon_2022_chemicals_weekdy))
print("HRall_CO2_FC_Other_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CO2_FC_Other_MetricTon_2022_chemicals_weekdy))
print("dayav_CO2_FC_Other_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CO2_FC_Other_MetricTon_2022_chemicals_satdy))
print("HRall_CO2_FC_Other_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CO2_FC_Other_MetricTon_2022_chemicals_satdy))
print("dayav_CO2_FC_Other_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CO2_FC_Other_MetricTon_2022_chemicals_sundy))
print("HRall_CO2_FC_Other_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CO2_FC_Other_MetricTon_2022_chemicals_sundy))

###################################################################################################
#CH4
###################################################################################################
HRall_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_Coal_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_Coal_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_NG_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_NG_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_NG_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_Other_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_Other_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_FC_Other_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
...
for pt in range(0,len(LON_chemicals)):
    ...
    HRall_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy[pt]*PtIND_Coal_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Coal_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CH4_FC_Coal_MetricTon_2022_chemicals_satdy[pt]*PtIND_Coal_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Coal_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CH4_FC_Coal_MetricTon_2022_chemicals_sundy[pt]*PtIND_Coal_sundy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_NG_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CH4_FC_NG_MetricTon_2022_chemicals_weekdy[pt]*PtIND_NG_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_NG_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CH4_FC_NG_MetricTon_2022_chemicals_satdy[pt]*PtIND_NG_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_NG_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CH4_FC_NG_MetricTon_2022_chemicals_sundy[pt]*PtIND_NG_sundy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Other_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CH4_FC_Other_MetricTon_2022_chemicals_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Other_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CH4_FC_Other_MetricTon_2022_chemicals_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Other_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CH4_FC_Other_MetricTon_2022_chemicals_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]

print("dayav_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy))
print("HRall_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy))
print("dayav_CH4_FC_Coal_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CH4_FC_Coal_MetricTon_2022_chemicals_satdy))
print("HRall_CH4_FC_Coal_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CH4_FC_Coal_MetricTon_2022_chemicals_satdy))
print("dayav_CH4_FC_Coal_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CH4_FC_Coal_MetricTon_2022_chemicals_sundy))
print("HRall_CH4_FC_Coal_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CH4_FC_Coal_MetricTon_2022_chemicals_sundy))
print("dayav_CH4_FC_NG_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CH4_FC_NG_MetricTon_2022_chemicals_weekdy))
print("HRall_CH4_FC_NG_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CH4_FC_NG_MetricTon_2022_chemicals_weekdy))
print("dayav_CH4_FC_NG_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CH4_FC_NG_MetricTon_2022_chemicals_satdy))
print("HRall_CH4_FC_NG_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CH4_FC_NG_MetricTon_2022_chemicals_satdy))
print("dayav_CH4_FC_NG_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CH4_FC_NG_MetricTon_2022_chemicals_sundy))
print("HRall_CH4_FC_NG_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CH4_FC_NG_MetricTon_2022_chemicals_sundy))
print("dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy))
print("HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy))
print("dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy))
print("HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy))
print("dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy))
print("HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy))
print("dayav_CH4_FC_Other_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CH4_FC_Other_MetricTon_2022_chemicals_weekdy))
print("HRall_CH4_FC_Other_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CH4_FC_Other_MetricTon_2022_chemicals_weekdy))
print("dayav_CH4_FC_Other_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CH4_FC_Other_MetricTon_2022_chemicals_satdy))
print("HRall_CH4_FC_Other_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CH4_FC_Other_MetricTon_2022_chemicals_satdy))
print("dayav_CH4_FC_Other_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CH4_FC_Other_MetricTon_2022_chemicals_sundy))
print("HRall_CH4_FC_Other_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CH4_FC_Other_MetricTon_2022_chemicals_sundy))
...
#CO2
###################################################################################################
HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
...
for pt in range(0,len(LON_minerals_metals)):
    ...
    HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy[pt]*PtIND_Coal_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy[pt]*PtIND_Coal_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy[pt]*PtIND_Coal_sundy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy[pt]*PtIND_NG_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy[pt]*PtIND_NG_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy[pt]*PtIND_NG_sundy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]

print("dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy))
print("HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy))
print("dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy))
print("HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy))
print("dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy))
print("HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy))
print("dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy))
print("HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy))
print("dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy))
print("HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy))
print("dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy))
print("HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy))
print("dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy))
print("HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy))
print("dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy))
print("HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy))

###################################################################################################
#CH4
###################################################################################################
HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
...
for pt in range(0,len(LON_minerals_metals)):
    ...
    HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy[pt]*PtIND_Coal_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy[pt]*PtIND_Coal_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy[pt]*PtIND_Coal_sundy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy[pt]*PtIND_NG_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy[pt]*PtIND_NG_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy[pt]*PtIND_NG_sundy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy[pt]*PtIND_Oil_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy[pt]*PtIND_Oil_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy[pt]*PtIND_Oil_sundy_states_HRall_frac[state_index,:]

print("dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy))
print("HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy))
print("dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy))
print("HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy))
print("dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy))
print("HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy))
print("dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy))
print("HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy))
print("dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy))
print("HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy))
print("dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy))
print("HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy))
print("dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy))
print("HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy))
print("dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy))
print("HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy))
...
#CO2
###################################################################################################
HRall_CO2_PE_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_PE_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CO2_PE_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
...
for pt in range(0,len(LON_refineries)):
    ...
    HRall_CO2_PE_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CO2_PE_MetricTon_2022_refineries_weekdy[pt]*PtREFINE_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_PE_MetricTon_2022_refineries_satdy[:,pt]= dayav_CO2_PE_MetricTon_2022_refineries_satdy[pt]*PtREFINE_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_PE_MetricTon_2022_refineries_sundy[:,pt]= dayav_CO2_PE_MetricTon_2022_refineries_sundy[pt]*PtREFINE_sundy_states_HRall_frac[state_index,:]

print("dayav_CO2_PE_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CO2_PE_MetricTon_2022_refineries_weekdy))
print("HRall_CO2_PE_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CO2_PE_MetricTon_2022_refineries_weekdy))
print("dayav_CO2_PE_MetricTon_2022_refineries_satdy",np.nansum(dayav_CO2_PE_MetricTon_2022_refineries_satdy))
print("HRall_CO2_PE_MetricTon_2022_refineries_satdy",np.nansum(HRall_CO2_PE_MetricTon_2022_refineries_satdy))
print("dayav_CO2_PE_MetricTon_2022_refineries_sundy",np.nansum(dayav_CO2_PE_MetricTon_2022_refineries_sundy))
print("HRall_CO2_PE_MetricTon_2022_refineries_sundy",np.nansum(HRall_CO2_PE_MetricTon_2022_refineries_sundy))

###################################################################################################
#CH4
###################################################################################################
HRall_CH4_PE_MetricTon_2022_refineries_weekdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_PE_MetricTon_2022_refineries_satdy = np.zeros([24,len(LON_refineries)])
HRall_CH4_PE_MetricTon_2022_refineries_sundy = np.zeros([24,len(LON_refineries)])
...
for pt in range(0,len(LON_refineries)):
    ...
    HRall_CH4_PE_MetricTon_2022_refineries_weekdy[:,pt]= dayav_CH4_PE_MetricTon_2022_refineries_weekdy[pt]*PtREFINE_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_PE_MetricTon_2022_refineries_satdy[:,pt]= dayav_CH4_PE_MetricTon_2022_refineries_satdy[pt]*PtREFINE_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_PE_MetricTon_2022_refineries_sundy[:,pt]= dayav_CH4_PE_MetricTon_2022_refineries_sundy[pt]*PtREFINE_sundy_states_HRall_frac[state_index,:]

print("dayav_CH4_PE_MetricTon_2022_refineries_weekdy",np.nansum(dayav_CH4_PE_MetricTon_2022_refineries_weekdy))
print("HRall_CH4_PE_MetricTon_2022_refineries_weekdy",np.nansum(HRall_CH4_PE_MetricTon_2022_refineries_weekdy))
print("dayav_CH4_PE_MetricTon_2022_refineries_satdy",np.nansum(dayav_CH4_PE_MetricTon_2022_refineries_satdy))
print("HRall_CH4_PE_MetricTon_2022_refineries_satdy",np.nansum(HRall_CH4_PE_MetricTon_2022_refineries_satdy))
print("dayav_CH4_PE_MetricTon_2022_refineries_sundy",np.nansum(dayav_CH4_PE_MetricTon_2022_refineries_sundy))
print("HRall_CH4_PE_MetricTon_2022_refineries_sundy",np.nansum(HRall_CH4_PE_MetricTon_2022_refineries_sundy))
...
#CO2
###################################################################################################
HRall_CO2_PE_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_PE_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CO2_PE_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
...
for pt in range(0,len(LON_chemicals)):
    ...
    HRall_CO2_PE_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CO2_PE_MetricTon_2022_chemicals_weekdy[pt]*PtCHEM_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_PE_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CO2_PE_MetricTon_2022_chemicals_satdy[pt]*PtCHEM_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_PE_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CO2_PE_MetricTon_2022_chemicals_sundy[pt]*PtCHEM_sundy_states_HRall_frac[state_index,:]

print("dayav_CO2_PE_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CO2_PE_MetricTon_2022_chemicals_weekdy))
print("HRall_CO2_PE_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CO2_PE_MetricTon_2022_chemicals_weekdy))
print("dayav_CO2_PE_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CO2_PE_MetricTon_2022_chemicals_satdy))
print("HRall_CO2_PE_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CO2_PE_MetricTon_2022_chemicals_satdy))
print("dayav_CO2_PE_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CO2_PE_MetricTon_2022_chemicals_sundy))
print("HRall_CO2_PE_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CO2_PE_MetricTon_2022_chemicals_sundy))

###################################################################################################
#CH4
###################################################################################################
HRall_CH4_PE_MetricTon_2022_chemicals_weekdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_PE_MetricTon_2022_chemicals_satdy = np.zeros([24,len(LON_chemicals)])
HRall_CH4_PE_MetricTon_2022_chemicals_sundy = np.zeros([24,len(LON_chemicals)])
...
for pt in range(0,len(LON_chemicals)):
    ...
    HRall_CH4_PE_MetricTon_2022_chemicals_weekdy[:,pt]= dayav_CH4_PE_MetricTon_2022_chemicals_weekdy[pt]*PtCHEM_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_PE_MetricTon_2022_chemicals_satdy[:,pt]= dayav_CH4_PE_MetricTon_2022_chemicals_satdy[pt]*PtCHEM_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_PE_MetricTon_2022_chemicals_sundy[:,pt]= dayav_CH4_PE_MetricTon_2022_chemicals_sundy[pt]*PtCHEM_sundy_states_HRall_frac[state_index,:]

print("dayav_CH4_PE_MetricTon_2022_chemicals_weekdy",np.nansum(dayav_CH4_PE_MetricTon_2022_chemicals_weekdy))
print("HRall_CH4_PE_MetricTon_2022_chemicals_weekdy",np.nansum(HRall_CH4_PE_MetricTon_2022_chemicals_weekdy))
print("dayav_CH4_PE_MetricTon_2022_chemicals_satdy",np.nansum(dayav_CH4_PE_MetricTon_2022_chemicals_satdy))
print("HRall_CH4_PE_MetricTon_2022_chemicals_satdy",np.nansum(HRall_CH4_PE_MetricTon_2022_chemicals_satdy))
print("dayav_CH4_PE_MetricTon_2022_chemicals_sundy",np.nansum(dayav_CH4_PE_MetricTon_2022_chemicals_sundy))
print("HRall_CH4_PE_MetricTon_2022_chemicals_sundy",np.nansum(HRall_CH4_PE_MetricTon_2022_chemicals_sundy))
...
#CO2
###################################################################################################
HRall_CO2_PE_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_PE_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CO2_PE_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
...
for pt in range(0,len(LON_minerals_metals)):
    ...
    HRall_CO2_PE_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CO2_PE_MetricTon_2022_minerals_metals_weekdy[pt]*PtMETAL_weekdy_states_HRall_frac[state_index,:]
    HRall_CO2_PE_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CO2_PE_MetricTon_2022_minerals_metals_satdy[pt]*PtMETAL_satdy_states_HRall_frac[state_index,:]
    HRall_CO2_PE_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CO2_PE_MetricTon_2022_minerals_metals_sundy[pt]*PtMETAL_sundy_states_HRall_frac[state_index,:]

print("dayav_CO2_PE_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CO2_PE_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CO2_PE_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CO2_PE_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CO2_PE_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CO2_PE_MetricTon_2022_minerals_metals_satdy))
print("HRall_CO2_PE_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CO2_PE_MetricTon_2022_minerals_metals_satdy))
print("dayav_CO2_PE_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CO2_PE_MetricTon_2022_minerals_metals_sundy))
print("HRall_CO2_PE_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CO2_PE_MetricTon_2022_minerals_metals_sundy))

###################################################################################################
#CH4
###################################################################################################
HRall_CH4_PE_MetricTon_2022_minerals_metals_weekdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_PE_MetricTon_2022_minerals_metals_satdy = np.zeros([24,len(LON_minerals_metals)])
HRall_CH4_PE_MetricTon_2022_minerals_metals_sundy = np.zeros([24,len(LON_minerals_metals)])
...
for pt in range(0,len(LON_minerals_metals)):
    ...
    HRall_CH4_PE_MetricTon_2022_minerals_metals_weekdy[:,pt]= dayav_CH4_PE_MetricTon_2022_minerals_metals_weekdy[pt]*PtMETAL_weekdy_states_HRall_frac[state_index,:]
    HRall_CH4_PE_MetricTon_2022_minerals_metals_satdy[:,pt]= dayav_CH4_PE_MetricTon_2022_minerals_metals_satdy[pt]*PtMETAL_satdy_states_HRall_frac[state_index,:]
    HRall_CH4_PE_MetricTon_2022_minerals_metals_sundy[:,pt]= dayav_CH4_PE_MetricTon_2022_minerals_metals_sundy[pt]*PtMETAL_sundy_states_HRall_frac[state_index,:]

print("dayav_CH4_PE_MetricTon_2022_minerals_metals_weekdy",np.nansum(dayav_CH4_PE_MetricTon_2022_minerals_metals_weekdy))
print("HRall_CH4_PE_MetricTon_2022_minerals_metals_weekdy",np.nansum(HRall_CH4_PE_MetricTon_2022_minerals_metals_weekdy))
print("dayav_CH4_PE_MetricTon_2022_minerals_metals_satdy",np.nansum(dayav_CH4_PE_MetricTon_2022_minerals_metals_satdy))
print("HRall_CH4_PE_MetricTon_2022_minerals_metals_satdy",np.nansum(HRall_CH4_PE_MetricTon_2022_minerals_metals_satdy))
print("dayav_CH4_PE_MetricTon_2022_minerals_metals_sundy",np.nansum(dayav_CH4_PE_MetricTon_2022_minerals_metals_sundy))
print("HRall_CH4_PE_MetricTon_2022_minerals_metals_sundy",np.nansum(HRall_CH4_PE_MetricTon_2022_minerals_metals_sundy))
...
#scale refineries/chemicals/minerals and metals from 2022 annual average in metric tons/hr to 2022mm
PtINDF_monthly = pd.read_csv("/wrk/csd4/charkins/emissions/GRA2PES/V7_NRT_scaling/POINT22_202411/input/PtINDF_monthly.csv")
PtINDP_monthly = pd.read_csv("/wrk/csd4/charkins/emissions/GRA2PES/V7_NRT_scaling/POINT22_202411/input/PtINDP_monthly.csv")
...
PtIND_Coal_sf_2022mm = PtIND_Coal_sf_mm/PtIND_Coal_sf_aavg
PtIND_NG_sf_2022mm = PtIND_NG_sf_mm/PtIND_NG_sf_aavg
PtIND_Oil_sf_2022mm = PtIND_Oil_sf_mm/PtIND_Oil_sf_aavg

PtREFINE_sf_2022mm = PtREFINE_sf_mm/PtREFINE_sf_aavg
PtCHEM_sf_2022mm = PtCHEM_sf_mm/PtCHEM_sf_aavg
PtMETAL_sf_2022mm = PtMETAL_sf_mm/PtMETAL_sf_aavg

print("PtIND_Coal_sf_2022mm",PtIND_Coal_sf_2022mm)
print("PtIND_NG_sf_2022mm",PtIND_NG_sf_2022mm)
print("PtIND_Oil_sf_2022mm",PtIND_Oil_sf_2022mm)

print("PtREFINE_sf_2022mm",PtREFINE_sf_2022mm)
print("PtCHEM_sf_2022mm",PtCHEM_sf_2022mm)
print("PtMETAL_sf_2022mm",PtMETAL_sf_2022mm)

HRall_CO2_FC_Coal_MetricTon_2022mm_refineries_weekdy = HRall_CO2_FC_Coal_MetricTon_2022_refineries_weekdy * PtIND_Coal_sf_2022mm
HRall_CO2_FC_Coal_MetricTon_2022mm_refineries_satdy = HRall_CO2_FC_Coal_MetricTon_2022_refineries_satdy * PtIND_Coal_sf_2022mm
HRall_CO2_FC_Coal_MetricTon_2022mm_refineries_sundy = HRall_CO2_FC_Coal_MetricTon_2022_refineries_sundy * PtIND_Coal_sf_2022mm

HRall_CO2_FC_NG_MetricTon_2022mm_refineries_weekdy = HRall_CO2_FC_NG_MetricTon_2022_refineries_weekdy * PtIND_NG_sf_2022mm
HRall_CO2_FC_NG_MetricTon_2022mm_refineries_satdy = HRall_CO2_FC_NG_MetricTon_2022_refineries_satdy * PtIND_NG_sf_2022mm
HRall_CO2_FC_NG_MetricTon_2022mm_refineries_sundy = HRall_CO2_FC_NG_MetricTon_2022_refineries_sundy * PtIND_NG_sf_2022mm

HRall_CO2_FC_Petroleum_MetricTon_2022mm_refineries_weekdy = HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_weekdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Petroleum_MetricTon_2022mm_refineries_satdy = HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_satdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Petroleum_MetricTon_2022mm_refineries_sundy = HRall_CO2_FC_Petroleum_MetricTon_2022_refineries_sundy * PtIND_Oil_sf_2022mm

HRall_CO2_FC_Other_MetricTon_2022mm_refineries_weekdy = HRall_CO2_FC_Other_MetricTon_2022_refineries_weekdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Other_MetricTon_2022mm_refineries_satdy = HRall_CO2_FC_Other_MetricTon_2022_refineries_satdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Other_MetricTon_2022mm_refineries_sundy = HRall_CO2_FC_Other_MetricTon_2022_refineries_sundy * PtIND_Oil_sf_2022mm

HRall_CO2_PE_MetricTon_2022mm_refineries_weekdy = HRall_CO2_PE_MetricTon_2022_refineries_weekdy * PtREFINE_sf_2022mm
HRall_CO2_PE_MetricTon_2022mm_refineries_satdy = HRall_CO2_PE_MetricTon_2022_refineries_satdy * PtREFINE_sf_2022mm
HRall_CO2_PE_MetricTon_2022mm_refineries_sundy = HRall_CO2_PE_MetricTon_2022_refineries_sundy * PtREFINE_sf_2022mm

HRall_CH4_FC_Coal_MetricTon_2022mm_refineries_weekdy = HRall_CH4_FC_Coal_MetricTon_2022_refineries_weekdy * PtIND_Coal_sf_2022mm
HRall_CH4_FC_Coal_MetricTon_2022mm_refineries_satdy = HRall_CH4_FC_Coal_MetricTon_2022_refineries_satdy * PtIND_Coal_sf_2022mm
HRall_CH4_FC_Coal_MetricTon_2022mm_refineries_sundy = HRall_CH4_FC_Coal_MetricTon_2022_refineries_sundy * PtIND_Coal_sf_2022mm

HRall_CH4_FC_NG_MetricTon_2022mm_refineries_weekdy = HRall_CH4_FC_NG_MetricTon_2022_refineries_weekdy * PtIND_NG_sf_2022mm
HRall_CH4_FC_NG_MetricTon_2022mm_refineries_satdy = HRall_CH4_FC_NG_MetricTon_2022_refineries_satdy * PtIND_NG_sf_2022mm
HRall_CH4_FC_NG_MetricTon_2022mm_refineries_sundy = HRall_CH4_FC_NG_MetricTon_2022_refineries_sundy * PtIND_NG_sf_2022mm

HRall_CH4_FC_Petroleum_MetricTon_2022mm_refineries_weekdy = HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_weekdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Petroleum_MetricTon_2022mm_refineries_satdy = HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_satdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Petroleum_MetricTon_2022mm_refineries_sundy = HRall_CH4_FC_Petroleum_MetricTon_2022_refineries_sundy * PtIND_Oil_sf_2022mm

HRall_CH4_FC_Other_MetricTon_2022mm_refineries_weekdy = HRall_CH4_FC_Other_MetricTon_2022_refineries_weekdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Other_MetricTon_2022mm_refineries_satdy = HRall_CH4_FC_Other_MetricTon_2022_refineries_satdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Other_MetricTon_2022mm_refineries_sundy = HRall_CH4_FC_Other_MetricTon_2022_refineries_sundy * PtIND_Oil_sf_2022mm

HRall_CH4_PE_MetricTon_2022mm_refineries_weekdy = HRall_CH4_PE_MetricTon_2022_refineries_weekdy * PtREFINE_sf_2022mm
HRall_CH4_PE_MetricTon_2022mm_refineries_satdy = HRall_CH4_PE_MetricTon_2022_refineries_satdy * PtREFINE_sf_2022mm
HRall_CH4_PE_MetricTon_2022mm_refineries_sundy = HRall_CH4_PE_MetricTon_2022_refineries_sundy * PtREFINE_sf_2022mm

HRall_CO2_FC_Coal_MetricTon_2022mm_chemicals_weekdy = HRall_CO2_FC_Coal_MetricTon_2022_chemicals_weekdy * PtIND_Coal_sf_2022mm
HRall_CO2_FC_Coal_MetricTon_2022mm_chemicals_satdy = HRall_CO2_FC_Coal_MetricTon_2022_chemicals_satdy * PtIND_Coal_sf_2022mm
HRall_CO2_FC_Coal_MetricTon_2022mm_chemicals_sundy = HRall_CO2_FC_Coal_MetricTon_2022_chemicals_sundy * PtIND_Coal_sf_2022mm

HRall_CO2_FC_NG_MetricTon_2022mm_chemicals_weekdy = HRall_CO2_FC_NG_MetricTon_2022_chemicals_weekdy * PtIND_NG_sf_2022mm
HRall_CO2_FC_NG_MetricTon_2022mm_chemicals_satdy = HRall_CO2_FC_NG_MetricTon_2022_chemicals_satdy * PtIND_NG_sf_2022mm
HRall_CO2_FC_NG_MetricTon_2022mm_chemicals_sundy = HRall_CO2_FC_NG_MetricTon_2022_chemicals_sundy * PtIND_NG_sf_2022mm

HRall_CO2_FC_Petroleum_MetricTon_2022mm_chemicals_weekdy = HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_weekdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Petroleum_MetricTon_2022mm_chemicals_satdy = HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_satdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Petroleum_MetricTon_2022mm_chemicals_sundy = HRall_CO2_FC_Petroleum_MetricTon_2022_chemicals_sundy * PtIND_Oil_sf_2022mm

HRall_CO2_FC_Other_MetricTon_2022mm_chemicals_weekdy = HRall_CO2_FC_Other_MetricTon_2022_chemicals_weekdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Other_MetricTon_2022mm_chemicals_satdy = HRall_CO2_FC_Other_MetricTon_2022_chemicals_satdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Other_MetricTon_2022mm_chemicals_sundy = HRall_CO2_FC_Other_MetricTon_2022_chemicals_sundy * PtIND_Oil_sf_2022mm

HRall_CO2_PE_MetricTon_2022mm_chemicals_weekdy = HRall_CO2_PE_MetricTon_2022_chemicals_weekdy * PtCHEM_sf_2022mm
HRall_CO2_PE_MetricTon_2022mm_chemicals_satdy = HRall_CO2_PE_MetricTon_2022_chemicals_satdy * PtCHEM_sf_2022mm
HRall_CO2_PE_MetricTon_2022mm_chemicals_sundy = HRall_CO2_PE_MetricTon_2022_chemicals_sundy * PtCHEM_sf_2022mm

HRall_CH4_FC_Coal_MetricTon_2022mm_chemicals_weekdy = HRall_CH4_FC_Coal_MetricTon_2022_chemicals_weekdy * PtIND_Coal_sf_2022mm
HRall_CH4_FC_Coal_MetricTon_2022mm_chemicals_satdy = HRall_CH4_FC_Coal_MetricTon_2022_chemicals_satdy * PtIND_Coal_sf_2022mm
HRall_CH4_FC_Coal_MetricTon_2022mm_chemicals_sundy = HRall_CH4_FC_Coal_MetricTon_2022_chemicals_sundy * PtIND_Coal_sf_2022mm

HRall_CH4_FC_NG_MetricTon_2022mm_chemicals_weekdy = HRall_CH4_FC_NG_MetricTon_2022_chemicals_weekdy * PtIND_NG_sf_2022mm
HRall_CH4_FC_NG_MetricTon_2022mm_chemicals_satdy = HRall_CH4_FC_NG_MetricTon_2022_chemicals_satdy * PtIND_NG_sf_2022mm
HRall_CH4_FC_NG_MetricTon_2022mm_chemicals_sundy = HRall_CH4_FC_NG_MetricTon_2022_chemicals_sundy * PtIND_NG_sf_2022mm

HRall_CH4_FC_Petroleum_MetricTon_2022mm_chemicals_weekdy = HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_weekdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Petroleum_MetricTon_2022mm_chemicals_satdy = HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_satdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Petroleum_MetricTon_2022mm_chemicals_sundy = HRall_CH4_FC_Petroleum_MetricTon_2022_chemicals_sundy * PtIND_Oil_sf_2022mm

HRall_CH4_FC_Other_MetricTon_2022mm_chemicals_weekdy = HRall_CH4_FC_Other_MetricTon_2022_chemicals_weekdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Other_MetricTon_2022mm_chemicals_satdy = HRall_CH4_FC_Other_MetricTon_2022_chemicals_satdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Other_MetricTon_2022mm_chemicals_sundy = HRall_CH4_FC_Other_MetricTon_2022_chemicals_sundy * PtIND_Oil_sf_2022mm

HRall_CH4_PE_MetricTon_2022mm_chemicals_weekdy = HRall_CH4_PE_MetricTon_2022_chemicals_weekdy * PtCHEM_sf_2022mm
HRall_CH4_PE_MetricTon_2022mm_chemicals_satdy = HRall_CH4_PE_MetricTon_2022_chemicals_satdy * PtCHEM_sf_2022mm
HRall_CH4_PE_MetricTon_2022mm_chemicals_sundy = HRall_CH4_PE_MetricTon_2022_chemicals_sundy * PtCHEM_sf_2022mm

HRall_CO2_FC_Coal_MetricTon_2022mm_minerals_metals_weekdy = HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_weekdy * PtIND_Coal_sf_2022mm
HRall_CO2_FC_Coal_MetricTon_2022mm_minerals_metals_satdy = HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_satdy * PtIND_Coal_sf_2022mm
HRall_CO2_FC_Coal_MetricTon_2022mm_minerals_metals_sundy = HRall_CO2_FC_Coal_MetricTon_2022_minerals_metals_sundy * PtIND_Coal_sf_2022mm

HRall_CO2_FC_NG_MetricTon_2022mm_minerals_metals_weekdy = HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_weekdy * PtIND_NG_sf_2022mm
HRall_CO2_FC_NG_MetricTon_2022mm_minerals_metals_satdy = HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_satdy * PtIND_NG_sf_2022mm
HRall_CO2_FC_NG_MetricTon_2022mm_minerals_metals_sundy = HRall_CO2_FC_NG_MetricTon_2022_minerals_metals_sundy * PtIND_NG_sf_2022mm

HRall_CO2_FC_Petroleum_MetricTon_2022mm_minerals_metals_weekdy = HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Petroleum_MetricTon_2022mm_minerals_metals_satdy = HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_satdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Petroleum_MetricTon_2022mm_minerals_metals_sundy = HRall_CO2_FC_Petroleum_MetricTon_2022_minerals_metals_sundy * PtIND_Oil_sf_2022mm

HRall_CO2_FC_Other_MetricTon_2022mm_minerals_metals_weekdy = HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_weekdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Other_MetricTon_2022mm_minerals_metals_satdy = HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_satdy * PtIND_Oil_sf_2022mm
HRall_CO2_FC_Other_MetricTon_2022mm_minerals_metals_sundy = HRall_CO2_FC_Other_MetricTon_2022_minerals_metals_sundy * PtIND_Oil_sf_2022mm

HRall_CO2_PE_MetricTon_2022mm_minerals_metals_weekdy = HRall_CO2_PE_MetricTon_2022_minerals_metals_weekdy * PtMETAL_sf_2022mm
HRall_CO2_PE_MetricTon_2022mm_minerals_metals_satdy = HRall_CO2_PE_MetricTon_2022_minerals_metals_satdy * PtMETAL_sf_2022mm
HRall_CO2_PE_MetricTon_2022mm_minerals_metals_sundy = HRall_CO2_PE_MetricTon_2022_minerals_metals_sundy * PtMETAL_sf_2022mm

HRall_CH4_FC_Coal_MetricTon_2022mm_minerals_metals_weekdy = HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_weekdy * PtIND_Coal_sf_2022mm
HRall_CH4_FC_Coal_MetricTon_2022mm_minerals_metals_satdy = HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_satdy * PtIND_Coal_sf_2022mm
HRall_CH4_FC_Coal_MetricTon_2022mm_minerals_metals_sundy = HRall_CH4_FC_Coal_MetricTon_2022_minerals_metals_sundy * PtIND_Coal_sf_2022mm

HRall_CH4_FC_NG_MetricTon_2022mm_minerals_metals_weekdy = HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_weekdy * PtIND_NG_sf_2022mm
HRall_CH4_FC_NG_MetricTon_2022mm_minerals_metals_satdy = HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_satdy * PtIND_NG_sf_2022mm
HRall_CH4_FC_NG_MetricTon_2022mm_minerals_metals_sundy = HRall_CH4_FC_NG_MetricTon_2022_minerals_metals_sundy * PtIND_NG_sf_2022mm

HRall_CH4_FC_Petroleum_MetricTon_2022mm_minerals_metals_weekdy = HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_weekdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Petroleum_MetricTon_2022mm_minerals_metals_satdy = HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_satdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Petroleum_MetricTon_2022mm_minerals_metals_sundy = HRall_CH4_FC_Petroleum_MetricTon_2022_minerals_metals_sundy * PtIND_Oil_sf_2022mm

HRall_CH4_FC_Other_MetricTon_2022mm_minerals_metals_weekdy = HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_weekdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Other_MetricTon_2022mm_minerals_metals_satdy = HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_satdy * PtIND_Oil_sf_2022mm
HRall_CH4_FC_Other_MetricTon_2022mm_minerals_metals_sundy = HRall_CH4_FC_Other_MetricTon_2022_minerals_metals_sundy * PtIND_Oil_sf_2022mm

HRall_CH4_PE_MetricTon_2022mm_minerals_metals_weekdy = HRall_CH4_PE_MetricTon_2022_minerals_metals_weekdy * PtMETAL_sf_2022mm
HRall_CH4_PE_MetricTon_2022mm_minerals_metals_satdy = HRall_CH4_PE_MetricTon_2022_minerals_metals_satdy * PtMETAL_sf_2022mm
HRall_CH4_PE_MetricTon_2022mm_minerals_metals_sundy = HRall_CH4_PE_MetricTon_2022_minerals_metals_sundy * PtMETAL_sf_2022mm
...
TotlPoint_00to12Z_weekdy_fn = base_dir+'/weekdy/TotlPoint_noOG_00to12Z.nc'
...
##################################################################################
extra_CO2_EGU = HRall_CO2_Emis_MetricTon_2022mm_weekdy[0:12,:]

##################################################################################
extra_CO2_FC_Coal_refineries = HRall_CO2_FC_Coal_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CO2_FC_Coal_chemicals = HRall_CO2_FC_Coal_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CO2_FC_Coal_minerals_metals = HRall_CO2_FC_Coal_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
extra_CO2_FC_NG_refineries = HRall_CO2_FC_NG_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CO2_FC_NG_chemicals = HRall_CO2_FC_NG_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CO2_FC_NG_minerals_metals = HRall_CO2_FC_NG_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
extra_CO2_FC_Petroleum_refineries = HRall_CO2_FC_Petroleum_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CO2_FC_Petroleum_chemicals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CO2_FC_Petroleum_minerals_metals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
extra_CO2_FC_Other_refineries = HRall_CO2_FC_Other_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CO2_FC_Other_chemicals = HRall_CO2_FC_Other_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CO2_FC_Other_minerals_metals = HRall_CO2_FC_Other_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
extra_CO2_PE_refineries = HRall_CO2_PE_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CO2_PE_chemicals = HRall_CO2_PE_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CO2_PE_minerals_metals = HRall_CO2_PE_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
##################################################################################
extra_CH4_FC_Coal_refineries = HRall_CH4_FC_Coal_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CH4_FC_Coal_chemicals = HRall_CH4_FC_Coal_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CH4_FC_Coal_minerals_metals = HRall_CH4_FC_Coal_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
extra_CH4_FC_NG_refineries = HRall_CH4_FC_NG_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CH4_FC_NG_chemicals = HRall_CH4_FC_NG_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CH4_FC_NG_minerals_metals = HRall_CH4_FC_NG_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
extra_CH4_FC_Petroleum_refineries = HRall_CH4_FC_Petroleum_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CH4_FC_Petroleum_chemicals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CH4_FC_Petroleum_minerals_metals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
extra_CH4_FC_Other_refineries = HRall_CH4_FC_Other_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CH4_FC_Other_chemicals = HRall_CH4_FC_Other_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CH4_FC_Other_minerals_metals = HRall_CH4_FC_Other_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
extra_CH4_PE_refineries = HRall_CH4_PE_MetricTon_2022mm_refineries_weekdy[0:12,:]
extra_CH4_PE_chemicals = HRall_CH4_PE_MetricTon_2022mm_chemicals_weekdy[0:12,:]
extra_CH4_PE_minerals_metals = HRall_CH4_PE_MetricTon_2022mm_minerals_metals_weekdy[0:12,:]
...
for pt in range(0,nROW_extra_EGU):
    ...
    if state_cur in states_vector:
        ...
        warning_message = ' Pt ' + str(pt)+  ' Categorized as Ontario, using X to CO2 ratios from Michigan instead'
        print(warning_message)
        if warning:
            warning = {'Message': warning['Message']+ ' \n' + warning_message}
        else:
        ...
        warning_message = ' Pt ' + str(pt)+  ' Categorized as Baja California, using X to CO2 ratios from California instead'
        print(warning_message)
        if warning:
            warning = {'Message': warning['Message']+ ' \n' + warning_message}
        else:
        ...
        warning_message = ' Pt ' + str(pt)+  ' Categorized as Washington, D.C., using X to CO2 ratios from District of Columbia instead'
        print(warning_message)
        if warning:
            warning = {'Message': warning['Message']+ ' \n' + warning_message}
        else:
        ...
        warning_message = ' Pt ' + str(pt)+  ' Categorized as something other than tracked states, using X to CO2 ratios from median of all states instead'
        print(warning_message)
        if warning:
            warning = {'Message': warning['Message']+ ' \n' + warning_message}
        else:
        ...
        for spec_cur in species_vector:
            spec_index = species_vector.index(spec_cur)
            #print("spec_index",spec_index)
            extra_X_EGU[:,pt,spec_index] = extra_CO2_EGU[:,pt] * statistics.median(fuel_spec_state_emisXdCO2_EGU[fuel_index,spec_index,:])

extra_X_EGU_dict = {}
for spec_cur in species_vector:
    #for SO2 and NOX use CEMS EGU numbers
    if spec_cur == 'SO2':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_SO2_Emis_MetricTon_2022mm_weekdy[0:12,:]
    elif spec_cur == 'NOX':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_NOx_Emis_MetricTon_2022mm_weekdy[0:12,:]
    else:
        spec_index = species_vector.index(spec_cur)
        #print("spec_index",spec_index)
...
for spec_cur in species_vector:
    ...
    extra_X = np.concatenate((extra_Xi_EGU,extra_Xi_IND,extra_Xi_OG*0),axis=1)
...
TotlPoint_w_extra_00to12Z_weekdy_fn = append_dir+'/weekdy/TotlPoint_noOG_00to12Z.nc'
...
###################################################################################################
#read original variables
TotlPoint_12to24Z_weekdy_fn = base_dir+'/weekdy/TotlPoint_noOG_12to24Z.nc'
...
##################################################################################
extra_CO2_EGU = HRall_CO2_Emis_MetricTon_2022mm_weekdy[12:24,:]

##################################################################################
extra_CO2_FC_Coal_refineries = HRall_CO2_FC_Coal_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CO2_FC_Coal_chemicals = HRall_CO2_FC_Coal_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CO2_FC_Coal_minerals_metals = HRall_CO2_FC_Coal_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CO2_FC_Coal_IND = np.concatenate((extra_CO2_FC_Coal_refineries,extra_CO2_FC_Coal_chemicals,extra_CO2_FC_Coal_minerals_metals),axis=1)

extra_CO2_FC_NG_refineries = HRall_CO2_FC_NG_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CO2_FC_NG_chemicals = HRall_CO2_FC_NG_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CO2_FC_NG_minerals_metals = HRall_CO2_FC_NG_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CO2_FC_NG_IND = np.concatenate((extra_CO2_FC_NG_refineries,extra_CO2_FC_NG_chemicals,extra_CO2_FC_NG_minerals_metals),axis=1)

extra_CO2_FC_Petroleum_refineries = HRall_CO2_FC_Petroleum_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CO2_FC_Petroleum_chemicals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CO2_FC_Petroleum_minerals_metals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CO2_FC_Petroleum_IND = np.concatenate((extra_CO2_FC_Petroleum_refineries,extra_CO2_FC_Petroleum_chemicals,extra_CO2_FC_Petroleum_minerals_metals),axis=1)

extra_CO2_FC_Other_refineries = HRall_CO2_FC_Other_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CO2_FC_Other_chemicals = HRall_CO2_FC_Other_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CO2_FC_Other_minerals_metals = HRall_CO2_FC_Other_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CO2_FC_Other_IND = np.concatenate((extra_CO2_FC_Other_refineries,extra_CO2_FC_Other_chemicals,extra_CO2_FC_Other_minerals_metals),axis=1)

extra_CO2_PE_refineries = HRall_CO2_PE_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CO2_PE_chemicals = HRall_CO2_PE_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CO2_PE_minerals_metals = HRall_CO2_PE_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CO2_PE_IND = np.concatenate((extra_CO2_PE_refineries,extra_CO2_PE_chemicals,extra_CO2_PE_minerals_metals),axis=1)
...
##################################################################################
extra_CH4_FC_Coal_refineries = HRall_CH4_FC_Coal_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CH4_FC_Coal_chemicals = HRall_CH4_FC_Coal_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CH4_FC_Coal_minerals_metals = HRall_CH4_FC_Coal_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CH4_FC_Coal_IND = np.concatenate((extra_CH4_FC_Coal_refineries,extra_CH4_FC_Coal_chemicals,extra_CH4_FC_Coal_minerals_metals),axis=1)

extra_CH4_FC_NG_refineries = HRall_CH4_FC_NG_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CH4_FC_NG_chemicals = HRall_CH4_FC_NG_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CH4_FC_NG_minerals_metals = HRall_CH4_FC_NG_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CH4_FC_NG_IND = np.concatenate((extra_CH4_FC_NG_refineries,extra_CH4_FC_NG_chemicals,extra_CH4_FC_NG_minerals_metals),axis=1)

extra_CH4_FC_Petroleum_refineries = HRall_CH4_FC_Petroleum_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CH4_FC_Petroleum_chemicals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CH4_FC_Petroleum_minerals_metals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CH4_FC_Petroleum_IND = np.concatenate((extra_CH4_FC_Petroleum_refineries,extra_CH4_FC_Petroleum_chemicals,extra_CH4_FC_Petroleum_minerals_metals),axis=1)

extra_CH4_FC_Other_refineries = HRall_CH4_FC_Other_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CH4_FC_Other_chemicals = HRall_CH4_FC_Other_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CH4_FC_Other_minerals_metals = HRall_CH4_FC_Other_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CH4_FC_Other_IND = np.concatenate((extra_CH4_FC_Other_refineries,extra_CH4_FC_Other_chemicals,extra_CH4_FC_Other_minerals_metals),axis=1)

extra_CH4_PE_refineries = HRall_CH4_PE_MetricTon_2022mm_refineries_weekdy[12:24,:]
extra_CH4_PE_chemicals = HRall_CH4_PE_MetricTon_2022mm_chemicals_weekdy[12:24,:]
extra_CH4_PE_minerals_metals = HRall_CH4_PE_MetricTon_2022mm_minerals_metals_weekdy[12:24,:]
extra_CH4_PE_IND = np.concatenate((extra_CH4_PE_refineries,extra_CH4_PE_chemicals,extra_CH4_PE_minerals_metals),axis=1)
...
for spec_cur in species_vector:
    #for SO2 and NOX use CEMS EGU numbers
    if spec_cur == 'SO2':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_SO2_Emis_MetricTon_2022mm_weekdy[12:24,:]
    elif spec_cur == 'NOX':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_NOx_Emis_MetricTon_2022mm_weekdy[12:24,:]
    else:
        spec_index = species_vector.index(spec_cur)
        #print("spec_index",spec_index)
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = extra_X_EGU[:,:,spec_index]
...
###################################################################################################
#write total points with extra points appended
TotlPoint_w_extra_12to24Z_weekdy_fn = append_dir+'/weekdy/TotlPoint_noOG_12to24Z.nc'
...
###################################################################################################
#read original variables
TotlPoint_00to12Z_satdy_fn = base_dir+'/satdy/TotlPoint_noOG_00to12Z.nc'
...
##################################################################################
extra_CO2_EGU = HRall_CO2_Emis_MetricTon_2022mm_satdy[0:12,:]

##################################################################################
extra_CO2_FC_Coal_refineries = HRall_CO2_FC_Coal_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CO2_FC_Coal_chemicals = HRall_CO2_FC_Coal_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CO2_FC_Coal_minerals_metals = HRall_CO2_FC_Coal_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CO2_FC_Coal_IND = np.concatenate((extra_CO2_FC_Coal_refineries,extra_CO2_FC_Coal_chemicals,extra_CO2_FC_Coal_minerals_metals),axis=1)

extra_CO2_FC_NG_refineries = HRall_CO2_FC_NG_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CO2_FC_NG_chemicals = HRall_CO2_FC_NG_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CO2_FC_NG_minerals_metals = HRall_CO2_FC_NG_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CO2_FC_NG_IND = np.concatenate((extra_CO2_FC_NG_refineries,extra_CO2_FC_NG_chemicals,extra_CO2_FC_NG_minerals_metals),axis=1)

extra_CO2_FC_Petroleum_refineries = HRall_CO2_FC_Petroleum_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CO2_FC_Petroleum_chemicals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CO2_FC_Petroleum_minerals_metals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CO2_FC_Petroleum_IND = np.concatenate((extra_CO2_FC_Petroleum_refineries,extra_CO2_FC_Petroleum_chemicals,extra_CO2_FC_Petroleum_minerals_metals),axis=1)

extra_CO2_FC_Other_refineries = HRall_CO2_FC_Other_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CO2_FC_Other_chemicals = HRall_CO2_FC_Other_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CO2_FC_Other_minerals_metals = HRall_CO2_FC_Other_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CO2_FC_Other_IND = np.concatenate((extra_CO2_FC_Other_refineries,extra_CO2_FC_Other_chemicals,extra_CO2_FC_Other_minerals_metals),axis=1)

extra_CO2_PE_refineries = HRall_CO2_PE_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CO2_PE_chemicals = HRall_CO2_PE_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CO2_PE_minerals_metals = HRall_CO2_PE_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CO2_PE_IND = np.concatenate((extra_CO2_PE_refineries,extra_CO2_PE_chemicals,extra_CO2_PE_minerals_metals),axis=1)
...
##################################################################################
extra_CH4_FC_Coal_refineries = HRall_CH4_FC_Coal_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CH4_FC_Coal_chemicals = HRall_CH4_FC_Coal_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CH4_FC_Coal_minerals_metals = HRall_CH4_FC_Coal_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CH4_FC_Coal_IND = np.concatenate((extra_CH4_FC_Coal_refineries,extra_CH4_FC_Coal_chemicals,extra_CH4_FC_Coal_minerals_metals),axis=1)

extra_CH4_FC_NG_refineries = HRall_CH4_FC_NG_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CH4_FC_NG_chemicals = HRall_CH4_FC_NG_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CH4_FC_NG_minerals_metals = HRall_CH4_FC_NG_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CH4_FC_NG_IND = np.concatenate((extra_CH4_FC_NG_refineries,extra_CH4_FC_NG_chemicals,extra_CH4_FC_NG_minerals_metals),axis=1)

extra_CH4_FC_Petroleum_refineries = HRall_CH4_FC_Petroleum_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CH4_FC_Petroleum_chemicals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CH4_FC_Petroleum_minerals_metals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CH4_FC_Petroleum_IND = np.concatenate((extra_CH4_FC_Petroleum_refineries,extra_CH4_FC_Petroleum_chemicals,extra_CH4_FC_Petroleum_minerals_metals),axis=1)

extra_CH4_FC_Other_refineries = HRall_CH4_FC_Other_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CH4_FC_Other_chemicals = HRall_CH4_FC_Other_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CH4_FC_Other_minerals_metals = HRall_CH4_FC_Other_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CH4_FC_Other_IND = np.concatenate((extra_CH4_FC_Other_refineries,extra_CH4_FC_Other_chemicals,extra_CH4_FC_Other_minerals_metals),axis=1)

extra_CH4_PE_refineries = HRall_CH4_PE_MetricTon_2022mm_refineries_satdy[0:12,:]
extra_CH4_PE_chemicals = HRall_CH4_PE_MetricTon_2022mm_chemicals_satdy[0:12,:]
extra_CH4_PE_minerals_metals = HRall_CH4_PE_MetricTon_2022mm_minerals_metals_satdy[0:12,:]
extra_CH4_PE_IND = np.concatenate((extra_CH4_PE_refineries,extra_CH4_PE_chemicals,extra_CH4_PE_minerals_metals),axis=1)
...
for spec_cur in species_vector:
    #for SO2 and NOX use CEMS EGU numbers
    if spec_cur == 'SO2':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_SO2_Emis_MetricTon_2022mm_satdy[0:12,:]
    elif spec_cur == 'NOX':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_NOx_Emis_MetricTon_2022mm_satdy[0:12,:]
    else:
        spec_index = species_vector.index(spec_cur)
        #print("spec_index",spec_index)
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = extra_X_EGU[:,:,spec_index]
...
###################################################################################################
#write total points with extra points appended
TotlPoint_w_extra_00to12Z_satdy_fn = append_dir+'/satdy/TotlPoint_noOG_00to12Z.nc'
...
###################################################################################################
#read original variables
TotlPoint_12to24Z_satdy_fn = base_dir+'/satdy/TotlPoint_noOG_12to24Z.nc'
...
##################################################################################
extra_CO2_EGU = HRall_CO2_Emis_MetricTon_2022mm_satdy[12:24,:]

##################################################################################
extra_CO2_FC_Coal_refineries = HRall_CO2_FC_Coal_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CO2_FC_Coal_chemicals = HRall_CO2_FC_Coal_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CO2_FC_Coal_minerals_metals = HRall_CO2_FC_Coal_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CO2_FC_Coal_IND = np.concatenate((extra_CO2_FC_Coal_refineries,extra_CO2_FC_Coal_chemicals,extra_CO2_FC_Coal_minerals_metals),axis=1)

extra_CO2_FC_NG_refineries = HRall_CO2_FC_NG_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CO2_FC_NG_chemicals = HRall_CO2_FC_NG_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CO2_FC_NG_minerals_metals = HRall_CO2_FC_NG_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CO2_FC_NG_IND = np.concatenate((extra_CO2_FC_NG_refineries,extra_CO2_FC_NG_chemicals,extra_CO2_FC_NG_minerals_metals),axis=1)

extra_CO2_FC_Petroleum_refineries = HRall_CO2_FC_Petroleum_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CO2_FC_Petroleum_chemicals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CO2_FC_Petroleum_minerals_metals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CO2_FC_Petroleum_IND = np.concatenate((extra_CO2_FC_Petroleum_refineries,extra_CO2_FC_Petroleum_chemicals,extra_CO2_FC_Petroleum_minerals_metals),axis=1)

extra_CO2_FC_Other_refineries = HRall_CO2_FC_Other_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CO2_FC_Other_chemicals = HRall_CO2_FC_Other_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CO2_FC_Other_minerals_metals = HRall_CO2_FC_Other_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CO2_FC_Other_IND = np.concatenate((extra_CO2_FC_Other_refineries,extra_CO2_FC_Other_chemicals,extra_CO2_FC_Other_minerals_metals),axis=1)

extra_CO2_PE_refineries = HRall_CO2_PE_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CO2_PE_chemicals = HRall_CO2_PE_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CO2_PE_minerals_metals = HRall_CO2_PE_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CO2_PE_IND = np.concatenate((extra_CO2_PE_refineries,extra_CO2_PE_chemicals,extra_CO2_PE_minerals_metals),axis=1)
...
##################################################################################
extra_CH4_FC_Coal_refineries = HRall_CH4_FC_Coal_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CH4_FC_Coal_chemicals = HRall_CH4_FC_Coal_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CH4_FC_Coal_minerals_metals = HRall_CH4_FC_Coal_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CH4_FC_Coal_IND = np.concatenate((extra_CH4_FC_Coal_refineries,extra_CH4_FC_Coal_chemicals,extra_CH4_FC_Coal_minerals_metals),axis=1)

extra_CH4_FC_NG_refineries = HRall_CH4_FC_NG_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CH4_FC_NG_chemicals = HRall_CH4_FC_NG_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CH4_FC_NG_minerals_metals = HRall_CH4_FC_NG_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CH4_FC_NG_IND = np.concatenate((extra_CH4_FC_NG_refineries,extra_CH4_FC_NG_chemicals,extra_CH4_FC_NG_minerals_metals),axis=1)

extra_CH4_FC_Petroleum_refineries = HRall_CH4_FC_Petroleum_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CH4_FC_Petroleum_chemicals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CH4_FC_Petroleum_minerals_metals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CH4_FC_Petroleum_IND = np.concatenate((extra_CH4_FC_Petroleum_refineries,extra_CH4_FC_Petroleum_chemicals,extra_CH4_FC_Petroleum_minerals_metals),axis=1)

extra_CH4_FC_Other_refineries = HRall_CH4_FC_Other_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CH4_FC_Other_chemicals = HRall_CH4_FC_Other_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CH4_FC_Other_minerals_metals = HRall_CH4_FC_Other_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CH4_FC_Other_IND = np.concatenate((extra_CH4_FC_Other_refineries,extra_CH4_FC_Other_chemicals,extra_CH4_FC_Other_minerals_metals),axis=1)

extra_CH4_PE_refineries = HRall_CH4_PE_MetricTon_2022mm_refineries_satdy[12:24,:]
extra_CH4_PE_chemicals = HRall_CH4_PE_MetricTon_2022mm_chemicals_satdy[12:24,:]
extra_CH4_PE_minerals_metals = HRall_CH4_PE_MetricTon_2022mm_minerals_metals_satdy[12:24,:]
extra_CH4_PE_IND = np.concatenate((extra_CH4_PE_refineries,extra_CH4_PE_chemicals,extra_CH4_PE_minerals_metals),axis=1)
...
for spec_cur in species_vector:
    #for SO2 and NOX use CEMS EGU numbers
    if spec_cur == 'SO2':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_SO2_Emis_MetricTon_2022mm_satdy[12:24,:]
    elif spec_cur == 'NOX':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_NOx_Emis_MetricTon_2022mm_satdy[12:24,:]
    else:
        spec_index = species_vector.index(spec_cur)
        #print("spec_index",spec_index)
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = extra_X_EGU[:,:,spec_index]
...
###################################################################################################
#write total points with extra points appended
TotlPoint_w_extra_12to24Z_satdy_fn = append_dir+'/satdy/TotlPoint_noOG_12to24Z.nc'
...
###################################################################################################
#read original variables
TotlPoint_00to12Z_sundy_fn = base_dir+'/sundy/TotlPoint_noOG_00to12Z.nc'
...
##################################################################################
extra_CO2_EGU = HRall_CO2_Emis_MetricTon_2022mm_sundy[0:12,:]

##################################################################################
extra_CO2_FC_Coal_refineries = HRall_CO2_FC_Coal_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CO2_FC_Coal_chemicals = HRall_CO2_FC_Coal_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CO2_FC_Coal_minerals_metals = HRall_CO2_FC_Coal_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CO2_FC_Coal_IND = np.concatenate((extra_CO2_FC_Coal_refineries,extra_CO2_FC_Coal_chemicals,extra_CO2_FC_Coal_minerals_metals),axis=1)

extra_CO2_FC_NG_refineries = HRall_CO2_FC_NG_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CO2_FC_NG_chemicals = HRall_CO2_FC_NG_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CO2_FC_NG_minerals_metals = HRall_CO2_FC_NG_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CO2_FC_NG_IND = np.concatenate((extra_CO2_FC_NG_refineries,extra_CO2_FC_NG_chemicals,extra_CO2_FC_NG_minerals_metals),axis=1)

extra_CO2_FC_Petroleum_refineries = HRall_CO2_FC_Petroleum_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CO2_FC_Petroleum_chemicals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CO2_FC_Petroleum_minerals_metals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CO2_FC_Petroleum_IND = np.concatenate((extra_CO2_FC_Petroleum_refineries,extra_CO2_FC_Petroleum_chemicals,extra_CO2_FC_Petroleum_minerals_metals),axis=1)

extra_CO2_FC_Other_refineries = HRall_CO2_FC_Other_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CO2_FC_Other_chemicals = HRall_CO2_FC_Other_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CO2_FC_Other_minerals_metals = HRall_CO2_FC_Other_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CO2_FC_Other_IND = np.concatenate((extra_CO2_FC_Other_refineries,extra_CO2_FC_Other_chemicals,extra_CO2_FC_Other_minerals_metals),axis=1)

extra_CO2_PE_refineries = HRall_CO2_PE_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CO2_PE_chemicals = HRall_CO2_PE_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CO2_PE_minerals_metals = HRall_CO2_PE_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CO2_PE_IND = np.concatenate((extra_CO2_PE_refineries,extra_CO2_PE_chemicals,extra_CO2_PE_minerals_metals),axis=1)
...
##################################################################################
extra_CH4_FC_Coal_refineries = HRall_CH4_FC_Coal_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CH4_FC_Coal_chemicals = HRall_CH4_FC_Coal_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CH4_FC_Coal_minerals_metals = HRall_CH4_FC_Coal_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CH4_FC_Coal_IND = np.concatenate((extra_CH4_FC_Coal_refineries,extra_CH4_FC_Coal_chemicals,extra_CH4_FC_Coal_minerals_metals),axis=1)

extra_CH4_FC_NG_refineries = HRall_CH4_FC_NG_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CH4_FC_NG_chemicals = HRall_CH4_FC_NG_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CH4_FC_NG_minerals_metals = HRall_CH4_FC_NG_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CH4_FC_NG_IND = np.concatenate((extra_CH4_FC_NG_refineries,extra_CH4_FC_NG_chemicals,extra_CH4_FC_NG_minerals_metals),axis=1)

extra_CH4_FC_Petroleum_refineries = HRall_CH4_FC_Petroleum_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CH4_FC_Petroleum_chemicals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CH4_FC_Petroleum_minerals_metals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CH4_FC_Petroleum_IND = np.concatenate((extra_CH4_FC_Petroleum_refineries,extra_CH4_FC_Petroleum_chemicals,extra_CH4_FC_Petroleum_minerals_metals),axis=1)

extra_CH4_FC_Other_refineries = HRall_CH4_FC_Other_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CH4_FC_Other_chemicals = HRall_CH4_FC_Other_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CH4_FC_Other_minerals_metals = HRall_CH4_FC_Other_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CH4_FC_Other_IND = np.concatenate((extra_CH4_FC_Other_refineries,extra_CH4_FC_Other_chemicals,extra_CH4_FC_Other_minerals_metals),axis=1)

extra_CH4_PE_refineries = HRall_CH4_PE_MetricTon_2022mm_refineries_sundy[0:12,:]
extra_CH4_PE_chemicals = HRall_CH4_PE_MetricTon_2022mm_chemicals_sundy[0:12,:]
extra_CH4_PE_minerals_metals = HRall_CH4_PE_MetricTon_2022mm_minerals_metals_sundy[0:12,:]
extra_CH4_PE_IND = np.concatenate((extra_CH4_PE_refineries,extra_CH4_PE_chemicals,extra_CH4_PE_minerals_metals),axis=1)
...
for spec_cur in species_vector:
    #for SO2 and NOX use CEMS EGU numbers
    if spec_cur == 'SO2':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_SO2_Emis_MetricTon_2022mm_sundy[0:12,:]
    elif spec_cur == 'NOX':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_NOx_Emis_MetricTon_2022mm_sundy[0:12,:]
    else:
        spec_index = species_vector.index(spec_cur)
        #print("spec_index",spec_index)
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = extra_X_EGU[:,:,spec_index]
...
###################################################################################################
#write total points with extra points appended
TotlPoint_w_extra_00to12Z_sundy_fn = append_dir+'/sundy/TotlPoint_noOG_00to12Z.nc'
...
###################################################################################################
#read original variables
TotlPoint_12to24Z_sundy_fn = base_dir+'/sundy/TotlPoint_noOG_12to24Z.nc'
...
##################################################################################
extra_CO2_EGU = HRall_CO2_Emis_MetricTon_2022mm_sundy[12:24,:]

##################################################################################
extra_CO2_FC_Coal_refineries = HRall_CO2_FC_Coal_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CO2_FC_Coal_chemicals = HRall_CO2_FC_Coal_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CO2_FC_Coal_minerals_metals = HRall_CO2_FC_Coal_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CO2_FC_Coal_IND = np.concatenate((extra_CO2_FC_Coal_refineries,extra_CO2_FC_Coal_chemicals,extra_CO2_FC_Coal_minerals_metals),axis=1)

extra_CO2_FC_NG_refineries = HRall_CO2_FC_NG_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CO2_FC_NG_chemicals = HRall_CO2_FC_NG_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CO2_FC_NG_minerals_metals = HRall_CO2_FC_NG_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CO2_FC_NG_IND = np.concatenate((extra_CO2_FC_NG_refineries,extra_CO2_FC_NG_chemicals,extra_CO2_FC_NG_minerals_metals),axis=1)

extra_CO2_FC_Petroleum_refineries = HRall_CO2_FC_Petroleum_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CO2_FC_Petroleum_chemicals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CO2_FC_Petroleum_minerals_metals = HRall_CO2_FC_Petroleum_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CO2_FC_Petroleum_IND = np.concatenate((extra_CO2_FC_Petroleum_refineries,extra_CO2_FC_Petroleum_chemicals,extra_CO2_FC_Petroleum_minerals_metals),axis=1)

extra_CO2_FC_Other_refineries = HRall_CO2_FC_Other_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CO2_FC_Other_chemicals = HRall_CO2_FC_Other_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CO2_FC_Other_minerals_metals = HRall_CO2_FC_Other_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CO2_FC_Other_IND = np.concatenate((extra_CO2_FC_Other_refineries,extra_CO2_FC_Other_chemicals,extra_CO2_FC_Other_minerals_metals),axis=1)

extra_CO2_PE_refineries = HRall_CO2_PE_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CO2_PE_chemicals = HRall_CO2_PE_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CO2_PE_minerals_metals = HRall_CO2_PE_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CO2_PE_IND = np.concatenate((extra_CO2_PE_refineries,extra_CO2_PE_chemicals,extra_CO2_PE_minerals_metals),axis=1)
...
##################################################################################
extra_CH4_FC_Coal_refineries = HRall_CH4_FC_Coal_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CH4_FC_Coal_chemicals = HRall_CH4_FC_Coal_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CH4_FC_Coal_minerals_metals = HRall_CH4_FC_Coal_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CH4_FC_Coal_IND = np.concatenate((extra_CH4_FC_Coal_refineries,extra_CH4_FC_Coal_chemicals,extra_CH4_FC_Coal_minerals_metals),axis=1)

extra_CH4_FC_NG_refineries = HRall_CH4_FC_NG_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CH4_FC_NG_chemicals = HRall_CH4_FC_NG_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CH4_FC_NG_minerals_metals = HRall_CH4_FC_NG_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CH4_FC_NG_IND = np.concatenate((extra_CH4_FC_NG_refineries,extra_CH4_FC_NG_chemicals,extra_CH4_FC_NG_minerals_metals),axis=1)

extra_CH4_FC_Petroleum_refineries = HRall_CH4_FC_Petroleum_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CH4_FC_Petroleum_chemicals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CH4_FC_Petroleum_minerals_metals = HRall_CH4_FC_Petroleum_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CH4_FC_Petroleum_IND = np.concatenate((extra_CH4_FC_Petroleum_refineries,extra_CH4_FC_Petroleum_chemicals,extra_CH4_FC_Petroleum_minerals_metals),axis=1)

extra_CH4_FC_Other_refineries = HRall_CH4_FC_Other_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CH4_FC_Other_chemicals = HRall_CH4_FC_Other_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CH4_FC_Other_minerals_metals = HRall_CH4_FC_Other_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CH4_FC_Other_IND = np.concatenate((extra_CH4_FC_Other_refineries,extra_CH4_FC_Other_chemicals,extra_CH4_FC_Other_minerals_metals),axis=1)

extra_CH4_PE_refineries = HRall_CH4_PE_MetricTon_2022mm_refineries_sundy[12:24,:]
extra_CH4_PE_chemicals = HRall_CH4_PE_MetricTon_2022mm_chemicals_sundy[12:24,:]
extra_CH4_PE_minerals_metals = HRall_CH4_PE_MetricTon_2022mm_minerals_metals_sundy[12:24,:]
extra_CH4_PE_IND = np.concatenate((extra_CH4_PE_refineries,extra_CH4_PE_chemicals,extra_CH4_PE_minerals_metals),axis=1)
...
for spec_cur in species_vector:
    #for SO2 and NOX use CEMS EGU numbers
    if spec_cur == 'SO2':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_SO2_Emis_MetricTon_2022mm_sundy[12:24,:]
    elif spec_cur == 'NOX':
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = HRall_NOx_Emis_MetricTon_2022mm_sundy[12:24,:]
    else:
        spec_index = species_vector.index(spec_cur)
        #print("spec_index",spec_index)
        extra_X_EGU_dict["extra_{0}_EGU".format(spec_cur)] = extra_X_EGU[:,:,spec_index]
...
###################################################################################################
#write total points with extra points appended
TotlPoint_w_extra_12to24Z_sundy_fn = append_dir+'/sundy/TotlPoint_noOG_12to24Z.nc'
