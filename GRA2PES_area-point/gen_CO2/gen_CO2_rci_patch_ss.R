...
# Inputs
base_dir.area = '/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_ss_bug_fix/Patch_SS/CO_spatial_surrogates/' 
base_dir.point = '/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_ss_bug_fix/Patch_SS/CO_spatial_surrogates/'
...
emis.sector.area = c('IND_Coal')

emis.sector.point = c('PtIND_Coal')
