...
base.dir       <- "/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_GRA2PES2021/scal_sum_ncf/scaled2021_rds/point"
output.dir     <- "/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_GRA2PES2021/scal_sum_ncf/summed2021_rds/point"

#Define sectors following CAMS
sector.list  <- c("PtAVIATION")
out.name     <- "TotlPoint_AVIATION"
