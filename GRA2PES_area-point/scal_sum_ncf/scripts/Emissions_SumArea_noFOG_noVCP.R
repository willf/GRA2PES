...
base.dir   <- "/wrk/users/charkins/emissions/V7_GRA2PES/AREA21"
output.dir <- "/wrk/users/charkins/emissions/V7_GRA2PES/AREA21"

#Define sectors following CAMS
sector.list  <- c("AreaCOMM","AreaRES","AreaINDF","AreaINDP","AreaOG_noFOG","AreaFUG","AreaRAIL","AreaAG","AreaWASTE")
out.name     <- "TotlArea_noFOG_noVCP"
