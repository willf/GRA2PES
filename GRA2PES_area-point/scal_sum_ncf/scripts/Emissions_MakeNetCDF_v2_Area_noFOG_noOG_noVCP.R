...
base.dir     <- paste("/wrk/users/charkins/emissions/V7_GRA2PES/AREA21",sep="")
out.dir      <- paste("/wrk/users/charkins/emissions/V7_GRA2PES/AREA21_ncf",sep="")

sector.list  <- c("TotlArea_noFOG_noOG_noVCP")
