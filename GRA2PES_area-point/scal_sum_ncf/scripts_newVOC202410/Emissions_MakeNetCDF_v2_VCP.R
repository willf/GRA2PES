...
base.dir     <- paste("/wrk/users/charkins/emissions/V7_GRA2PES/VCP",substr(year,3,4),"_newVOC202410",sep="")
out.dir      <- paste("/wrk/users/charkins/emissions/V7_GRA2PES/VCP",substr(year,3,4),"_newVOC202410_ncf",sep="")
