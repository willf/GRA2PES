...
base.dir     <- paste("/wrk/users/charkins/emissions/V7_GRA2PES/Cooking",substr(year,3,4),"_newVOC202410",sep="")
out.dir      <- paste("/wrk/users/charkins/emissions/V7_GRA2PES/Cooking",substr(year,3,4),"_newVOC202410_ncf",sep="")
...
domain.dir   <- "/wrk/charkins/FIVE/FIVE_onroad_python/template/with_CO2ff/newVOC202410"
domain.files <- c("onroad_00to12Z.nc","onroad_12to24Z.nc")
