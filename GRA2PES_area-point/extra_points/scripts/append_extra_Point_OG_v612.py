...
mm = '12'
mm_index = 12
#base_dir = '/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_wrfchemi2021_input/point/Month'+mm+'/TotlPoint_OG'
#append_dir = '/wrk/csd4/clyu/GHG_CO2/Improving_inventory/V7_wrfchemi2021_input/point_append_extra/Month'+mm+'/TotlPoint_OG'


base_dir = '/wrk/users/charkins/emissions/V7_GRA2PES/POINT21_ncf/Month'+mm+'/PtOG'
append_dir = '/wrk/users/charkins/emissions/V7_GRA2PES/POINT21_ncf_append_extra/Month'+mm+'/PtOG'
...
#Mimic Stu's RELPT program, convert 2021 annual total emissions 
